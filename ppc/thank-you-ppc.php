...
<nav class="navbar navbar-inverse">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="https://www.smsstriker.com"><img src="https://www.smsstriker.com/ppc/img/logo.png" alt="striker logo"></a>
    </div>
...
<tbody>
<tr><td>Transaction ID</td><td>:</td><td><?php echo $_REQUEST['tn'];?></td></tr>
<tr><td>Status</td><td>:</td><td><?php echo $_REQUEST['rm'];?></td></tr>
...
<p>Click here to goto <a href="https://www.smsstriker.com/ppc/bulk-sms-services.html" style='color:white;font-weight:bold;text-decoration:underline;'>home page</a> </p>
</div>
</div>
...
<script src="https://www.smsstriker.com/ppc/js/jquery.validate.min.js"></script>
<script src="https://www.smsstriker.com/ppc/js/form_validation/js/jquery-validate.bootstrap-tooltip.js" type="text/javascript"></script>
...
$( document ).ready(function() {
	...
	//var trnStatus = "<?php echo $_REQUEST['rm'];?>"; 
        var urlvar="https://www.smsstriker.com/checkMail.php?accondDetails=1&trnID="+trn_id; 
