...
$backup_table = "campaigns_dlr_".$day_month.$day_year;
 $backup_query = "insert into campaigns_backup.$backup_table ( select * from sms.campaigns_to_dlr where date(delivered_on)='$day_before_yesterday' )";

$backup_result = mysql_query($backup_query);

//delete from sms_api_messages table of day before yesterdays
if($backup_result) {
	$delete_query = "delete from sms.campaigns_to_dlr where date(delivered_on) = '$day_before_yesterday'";
