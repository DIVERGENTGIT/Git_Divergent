...
mysql_select_db("sms");
  ...
  if($dlr != 8) {
	...
	echo $dlrstatus="update sms_api_messages set dlr_status='$dlr',error_code='$error_code',error_text='$error_txt',delivered_on=FROM_UNIXTIME($ts) where message_id='$campaign_id' and to_mobileno='$to'";
