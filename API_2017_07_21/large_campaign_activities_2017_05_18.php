		...
		for ($i = $from_row-1; $i <= $to_row; $i++) 
			{
				...
				*/
				...
				$mysqli->query("insert into schedule_campaigns_to set campaign_id='$campaign_id',unique_msg_id='$unique_num',sms_text='$message',to_mobile_no='$mobile_no',created_on='".date('Y-m-d H:i:s')."'");
