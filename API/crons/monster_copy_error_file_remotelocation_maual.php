...
// another user 	sms_api_messages_092017  DATE( DATE_SUB( NOW() , INTERVAL 1 DAY )
$date='2017-09-01';
...
FROM campaigns_backup.sms_api_messages_092017 where user_id=4094 and dlr_status not in (1,3) and date(ondate)='$date' order by ondate desc");
