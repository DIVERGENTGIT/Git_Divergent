...
function totalCreditsReport($mailContent) {
	...
	$mail->AddCC('supraja.thanga@office24by7.com', 'Daily Report');
	...
	$mail->AddCC('sudheer.k@office24by7.com', 'Daily Report');
	$mail->AddCC('rajkumar.g@office24by7.com', 'Daily Report');
	$mail->AddCC('srinivas.p@office24by7.com', 'Daily Report');		
	$mail->WordWrap = 50;        
	$mail->IsHTML(true);    
