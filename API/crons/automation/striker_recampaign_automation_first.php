	...
	if($getCampaignsProcessData->num_rows > 0 ) { 
		...
		while($campaignsProcessDataRes = $getCampaignsProcessData->fetch_assoc()) {
			...
			if($getUserType->num_rows > 0) {
				...
				//$mysqli->query("UPDATE campaigns_to SET port_no = '".$port_no."',re_campaign_status = 1 WHERE campaign_id = '".$campaign_id."' and to_mobile_no='".$to_mobile."' ");   
				$mysqli->query("UPDATE campaigns_to SET re_campaign_status = 1 WHERE campaign_id = '".$campaign_id."' and to_mobile_no='".$to_mobile."' ");   
