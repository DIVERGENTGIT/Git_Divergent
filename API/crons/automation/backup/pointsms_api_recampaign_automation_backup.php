...
$getReCampaigns = $mysqli->query("SELECT message_id,user_id,sender_name,message,to_mobileno,port_no FROM sms_api_messages WHERE (error_code = '083' OR error_code = '036' OR error_code = '019' OR error_code = '225' OR error_code = '245' OR error_code = '100' OR error_code = '103' OR error_code = '106' OR error_code = '024') AND re_campaign_status = 0 AND date(ondate) = date(NOW()) LIMIT 500"); 

//$getReCampaigns = $mysqli->query("SELECT *  FROM `sms_api_messages` WHERE `user_id` = 3008 and ondate >= '2018-06-19 05:33:02' and ondate <= '2018-06-19 09:15:48' and dlr_status = 0");   
