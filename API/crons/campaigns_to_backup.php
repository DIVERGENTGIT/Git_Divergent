...
if($totalSMSCredits > 0) {
	$addCreditsQ = "INSERT INTO totalSMSCredits (total_numbers_count,failed_count,dnd_count,delivered_count,type,service,dateTime) VALUES('".$totalSMSCredits."','".$failedCredits."','".$dndCount."','".$deliveredCredits."','sms','smsstriker','".date('Y-m-d H:i:s')."')";  
