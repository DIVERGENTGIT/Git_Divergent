...
include("/var/www/html/strikerapp/smslib/config.inc");
    ...
    for($i=0;$i<count($mm);$i++) {
		...
		if($no_of_messages<=$available_credits) 
		{
			...
			if($to > 0) {
				...
				//$mysqli->query("INSERT INTO user_sms_credits_logs(before_campaign_credits,after_campaign_credits,current_campaign_credits,user_id,job_id) VALUES ('".$available_credits."','".$balance."','".$no_of_messages."','".$user_id."','".$job_id."') ");
			}  
	    ...
	    $CountryRoute = array("971" => "33013","91" => "33013","968" => "33013","966" => "33013","974" => "33013","90" => "33013","973" => "33013","962" => "33013","965" => "33013","60" => "33013","95" => "33013","63" => "33013","65" => "33013","84" => "33013","62" => "33013","852" => "33013","66" => "33013",);
	...
	if($International==1)
	{
		...
		$getphoneCode = $mysqli->query("select c.phonecode,c.nicename from countries c where c.phonecode=substring('$to',1,length(phonecode))");
 		$phoneCodeRes = $getphoneCode->fetch_array();
