...
// /dlr_work.php?campaign_id=13614859&smscID=vfirst_home&dlr=1&answer=id%3A4b621bc7-30bb-4621-87ab-7c440fc43b82+sub%3A001+dlvrd%3A001+submit+date%3A140825161513+done+date%3A140825161526+stat%3ADELIVRD+err%3A000+text%3ADefault&to=918806662605&from=SATCOP&ts=1408963856
...
$date=date("y-m-d");
	  	$err_arry = explode("stat",$ans);
	  	$direct_err_text= explode("+",$err_arry[1]);
        $error_text=$direct_err_text[0];
// echo  urldecode(urldecode($error_text));
