...
mysql_query("update ftp_campaigns_to set dlr_status='$dlrrec[dlr_status]',error_code='$dlrrec[error_code]',error_text='$dlrrec[error_text]',delivered_on=FROM_UNIXTIME($ts) where campaign_id='$dlrrec[campaign_id]' and to_mobile_no='$dlrrec[to_mobile_no]'");
