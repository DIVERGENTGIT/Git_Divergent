...
$link=mysqli_connect("localhost",$username,$password,$dbname);
  ...
  if($dlr != 8) {
	...
	$dlrapistmnt="update campaigns_to set dlr_status='$dlr',error_code='$error_code',error_text='$error_txt',delivered_on=FROM_UNIXTIME($ts) where campaign_id='$campaign_id' and to_mobile_no='$to'";

mysqli_query($link,$dlrapistmnt);
