...
$date=date("y-m-d");
$req = json_encode($_REQUEST,true);
error_log($dlrstatus,3,"/var/www/html/strikerapp/api_log/dlrs_log/dlr_".$date.".log");
  ...
  mysql_query("insert into campaigns_backup.campaigns_dlr_062017 set campaign_id=$campaign_id,to_mobile_no=$to, dlr_status='$dlr',error_code='$error_code',error_text='$error_txt',delivered_on=FROM_UNIXTIME($ts)");
