...
//error_log($req,3,"/var/www/html/strikerapp/api_log/dlrs_log/dlr_errorcode_log".$date.".log");
	  ...
	  }else if($smscID == "BS-TRANS" || $smscID == "BS-PRO" || $smscID == "strikersoftsmpp") {
  ...
  $dlrstatus= $file_name. "Campaign ID: ".$campaign_id. " to: ".$to." DLR: ".$dlr." smscID: ".$smscID." Error code: ".$error_code." Error Text: ".$error_txt."\n";
...
if($dlr == 2 && $error_code == '000' ) {
  ...
  mysql_query("insert into $backup_table set campaign_id=$campaign_id,to_mobile_no=$to, dlr_status='$dlr',error_code='$error_code',error_text='$error_txt',delivered_on=FROM_UNIXTIME($ts)");
