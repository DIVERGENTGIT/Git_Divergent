...
class LayoutHelper extends AppHelper
{
    ...
    {
        $avatar = $this->Html->image('http://www.gravatar.com/avatar/' . md5(strtolower($email)) . '?s=' . $size . '&d=identicon', array('alt' => $username, 'class' => 'avatar_image', 'width' => $size, 'height' => $size));
    ...
    {
        return $this->Html->image('http://www.gravatar.com/avatar/' . md5(strtolower($email)) . '?s=' . $size . '&d=identicon', array('alt' => $username, 'class' => 'avatar_image', 'width' => $size, 'height' => $size));
    }
