...
<div class="installation form">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">System Settings <span class="divider">/</span></li>
    ...
    <div class="progress">
        <div class="bar" style="width: 51%;">51%</div>
    </div>
    ...
    <fieldset>
        <?php
        echo '<h3 class="controls">' . __('System Settings') . '</h3>';
        echo $this->Form->input('Settings.System-language', array('label' => __('System Language'), 'type' => 'select', 'options' => AppLanguages::getAll()));
        ?>
    </fieldset>
    <div class="form-actions">
        <?php echo $this->Form->button(__('Continue'), array('class' => 'btn btn-primary', 'div' => false, 'escape' => false)); ?>
    </div>    
