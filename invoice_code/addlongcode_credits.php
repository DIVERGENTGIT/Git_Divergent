<?php
/***
http://localhost/strikerapp/API/longcode/invoice_addcredits.php?payment=payment&trn_id=201703020866819&servicetax=&tax=15&smsprice=
***/
	...
	$org=@$_REQUEST['org'];
	$amt=@$_REQUEST['amt'];
	$longcode_credits=@$_REQUEST['longcode_credits'];
	...
	$pricepersms='No of Longcode Credits @ '.$longcode_credits;
	...
	*/
	...
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(110, 112,$longcode_credits);
	$pdf->SetFont('Helvetica','',12);
