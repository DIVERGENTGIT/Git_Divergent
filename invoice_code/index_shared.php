<?php
	...
	*/
	...
	$service = 'Long Code Shared Numbers :';  
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(25, 118, $service);  
	$keywords = 'Total number of keywords :';  
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(25, 142, $keywords);  
	if($count == 1) { 
	$keywords_cost = $array[0]['keywords_cost'];
	//$package_cost = $keywords_cost-$array[0]['package_cost']; 
	$package_cost = $array[0]['package_cost'];
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(145, 112,$package_cost);  
	$pdf->SetFont('Helvetica','',12);
	$text1 = $array[0]['longcode_number'].' @ '.$array[0]['service_type'].' @ '.$array[0]['subscription_duration'];
	$pdf->text(25, 122, $text1);  
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 122,$array[0]['number_cost']);
	$keyword_num = 0;
	$keyword_num = $array[0]['no_of_keywords'];
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(110, 142,$keyword_num);
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 142,$keywords_cost);
	}else if($count == 2) {   
	$keywords_cost = $array[0]['keywords_cost'] + $array[1]['keywords_cost'];
	...
	$pdf->text(145, 122,$array[0]['number_cost']);
	$pdf->SetFont('Helvetica','',12);
	$text2 = $array[1]['longcode_number'].' @ '.$array[1]['service_type'].' @ '.$array[1]['subscription_duration'];
	$pdf->text(25, 126, $text2);  
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 126,$array[1]['number_cost']); 
	$keyword_num = 0;
	$keyword_num = $array[0]['no_of_keywords'] + $array[1]['no_of_keywords'];
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(110, 142,$keyword_num);
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 142,$keywords_cost);
	...
	$keywords_cost = $array[0]['keywords_cost'] + $array[1]['keywords_cost'] + $array[2]['keywords_cost'];
	...
	$pdf->text(145, 126,$array[1]['number_cost']); 
	$pdf->SetFont('Helvetica','',12);
	$text3 = $array[2]['longcode_number'].' @ '.$array[2]['service_type'].' @ '.$array[2]['subscription_duration'];
	$pdf->text(25, 130, $text3);  
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 130,$array[2]['number_cost']); 
	$keyword_num = 0;
	$keyword_num = $array[0]['no_of_keywords'] + $array[1]['no_of_keywords'] + $array[2]['no_of_keywords'];
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(110, 142,$keyword_num);
	$pdf->SetFont('Helvetica','',12);  
	$pdf->text(145, 142,$keywords_cost); 
