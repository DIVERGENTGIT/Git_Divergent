...
/***
http://localhost/strikerapp/API/shorturl/invoice_addcredits.php?payment=payment&trn_id=201701105873038&servicetax=&tax=15&smsprice=
***/
	...
	$org=@$_REQUEST['org'];
	$amt=@$_REQUEST['amt'];
	$shorturl_credits=@$_REQUEST['shorturl_credits'];
	...
	$pricepersms='No of Shorlurl Credits @ '.$shorturl_credits;
	...
	*/
	...
	$pdf->SetFont('Helvetica','',12);
	$pdf->text(110, 112,$shorturl_credits);
	$pdf->SetFont('Helvetica','',12);
