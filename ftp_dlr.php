...
//$a=explode("\n",$string);
$link=mysql_pconnect("localhost","root","myadmin");
mysql_select_db("sms");
//for($i=0;$i<count($a);$i++)
//{
  //$ss=$a[$i];
...
/*
$dlrdata=mysql_fetch_array(mysql_query("select count(*) as cnt from ftp_campaigns_to where error_code is null and campaign_id='$campaign_id' and to_mobile_no='$to' limit 1"));

if($dlrdata['cnt']!=0)
{
mysql_query("update ftp_campaigns_to set dlr_status='$dlr',error_code='$error_code',
