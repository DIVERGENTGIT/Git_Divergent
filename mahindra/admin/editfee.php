...
exit;
 		...
 		$qry1="select * from fee_receipt where id='".$_REQUEST['id']."'";
	...
	$qry2="update fee_receipt set   app_no='$app_no', `branch`='$branch',  `received_amount`='$receivedamount', `from_name`='$from_name',`towards`='$towards', `for_name`='$For_Name', `from_bank`='$from_bank', `branch_name`='$branch_name', `ddutrno`='$ddutrno', `create_date`='$paiddate',`ddutrdate`='$ddutrdate' ,currency_type='$currency' where id='".$_REQUEST['id']."'";
	$res2=mysql_query($qry2);
	 
  	 echo "<script>alert('Reciept updated successfully.');";	 
              ...
              <tr>
                ...
                <td align="right" valign="top"><table width="665" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <form name="frmcat" id="frmcat" method="post"  enctype="multipart/form-data"  action="<?php echo $_SERVER['PHP_SELF'];?>">
                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="390" class="textredblod" style="padding-bottom:15px;">Edit Fee Reciept <span class="textblackblod" style="padding-bottom:15px;"><img src="images/arrow1..jpg" width="7" height="6"></span></td>
                              ...
                              <tr>
                                <td colspan="3" bgcolor="#F6ECEC" style=" border-left:#8f8f8f 1px solid;border-right:#8f8f8f 1px solid;"><table width="532" border="0" align="center" cellpadding="4" cellspacing="4" class="normltext">
                                 <tr>
                                    ...
                                    <td width="331" align="left" style="padding-left:5px;"><input name="paiddate" id="dof" type="text" class="manditoryfield" style="width:100px; height:29px;" size="30"  value="<?php echo $row['create_date'];?>"  /></td>
                                  </tr>
                                 <!--  <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Roll No</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;">
                                    <input name="roll_no" id="roll_no" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['roll_no'];?>"   /></td>
                                  </tr>-->
                                  <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Application No</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;">
 <input name="app_no" id="app_no" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['app_no'];?>"    /></td>
                                  </tr>
								  
								   <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Branch</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="branch" id="branch" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['branch'];?>"    /></td>
                                  </tr>
                                 <!-- <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Installment</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="installment" id="installment" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['installment'];?>"   /></td>
                                  </tr>-->
                                     <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Received an amount</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="receivedamount" id="receivedamount" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['received_amount'];?>"    /></td>
                                  </tr>
                                     <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Name of Student</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="from_name" id="from_name" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['from_name'];?>"   /></td>
                                  </tr>
                                     <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Towards </td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="towards" id="towards" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['towards'];?>"    /></td>
                                  </tr>
                                   <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Mode of Payment
  </td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="For_Name" id="For_Name" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['for_name'];?>"  /></td>
                                  </tr>
                                     <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">Name of Bank  </td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="from_bank" id="from_bank" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['from_bank'];?>"   /></td>
                                  </tr>

<tr>
	<td width="155" align="right" class="textblack" style="font-weight: bold">Currency </td>
	<td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
	<td width="331" align="left" style="padding-left:5px;">

	<select name="currency" style="width:320px; height:29px;"> 
	<option value=" "> Select Currency </option>
	<option value="USD" <?php if($row['currency_type']=='USD'){ echo "selected";}?>> USD </option>
	<option value="EUR" <?php if($row['currency_type']=='EUR'){ echo "selected";}?>> EUR </option>
	<option value="INR" <?php if($row['currency_type']=='INR'){ echo "selected";}?>> INR </option>
	</select>
                                    ...
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;"><input name="branch_name" id="branch_name" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['branch_name'];?>"    /></td>
                                  </tr>
                                     <tr>
                                    <td width="155" align="right" class="textblack" style="font-weight: bold">DD/UTR NO</td>
                                    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
                                    <td width="331" align="left" style="padding-left:5px;">
                                    <input name="ddutrno" id="dd-utrno" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $row['ddutrno'];?>"   /></td>
                                  </tr>
 <tr>
    <td width="155" align="right" class="textblack" style="font-weight: bold">DD/UTR Date</td>
    <td width="6" height="22" align="center" valign="middle" style="padding-left:5px;"><strong class="textblack">:</strong></td>
    <td width="331" align="left" style="padding-left:5px;"><input name="ddutrdate" id="ddutrdate" type="text" class="manditoryfield" style="width:320px; height:29px;" size="30" value="<?php echo $row['ddutrdate'];?>"   /></td>
    </tr>				  
                                    ...
                                    <td align="left" style="padding-left:5px;"><table width="185" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="92" align="left" valign="top"><table width="64" border="0" align="left" cellpadding="0" cellspacing="0">
                                           <input name="id" id="id" type="hidden" class="manditoryfield" style="width:320px; height:29px;" size="30"  value="<?php echo $_REQUEST['id'];?>"   />
                                            <tr>
