...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  height: 30px; box-shadow:inset;" name="search" placeholder="Receipt no / application no" />
    <input type="submit" value="Search" name="submit" class="black" /></form> </span> </td></tr>
                        <tr>
                          <td colspan="6"  height="1" align="right"><a href="download.php" target="_self"><img src="images/excel.png"/></a></td>
                        </tr>
                        <tr>
...
-->
 <a href="JavaScript:newPopup
                                      ('http://mis.smsstriker.com/mahindra/admin/feereceipts.php?vid=<?php echo $fee_row['id']; ?>
                                     ');">
