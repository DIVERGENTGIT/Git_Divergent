            ...
            <td>
                <table width="100%" cellpadding="5" cellspacing="0" id="particulars">
                    <tr>
                        ...
                        <th>Branch</th>
                        <th>Fee Paid <?php if($row['currency_type']){ echo $row['currency_type'];}else{ echo "INR"; }?> </th>
                        <th>Towrds</th>
...
$stringword=ucwords(convert_number_to_words(number_format($row['received_amount'],2,'.','')));
if($row['currency_type']=='USD'){
echo str_replace("Rupees","Dollars",$stringword);
}elseif($row['currency_type']=='EUR'){
echo  str_replace("Rupees","Euros",$stringword);
}elseif($row['currency_type']=='INR'){
echo $stringword;
}
