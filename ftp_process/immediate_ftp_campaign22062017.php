...
$URL .= "$unicode_sms$mclass&dlr-mask=19&dlr-url=".urlencode("http://www.smsstriker.com/API/DLRS/ftp_dlr.php?campaign_id=$campaign_id&smscID=%i&dlr=%d&answer=%A&to=%p&from=%P&ts=%T");
