...
echo call_striker_longcode_api($sender,$dest,$body,$stime,$smsinfo);
...
$password="123456";
 ...
 call_waterboard_api($username,$password,$sender, $dest,$body,$stime);
        break;


	case 8367000060: // office2by7 

	call_office_longcode_api($sender,$dest,$body,$stime,$smsinfo);
	break;
...
function call_sms_api($user,$pwd,$message,$sender, $senderid, $messagetype){
		$api = "https://www.smsstriker.com/API/sms.php?";
		$api .= "username=$user&";
		$api .= "password=$pwd&";
		$api .= "to=".$sender."&";
 ...
 function  call_office_longcode_api($sender,$dest,$body,$stime,$smsinfo){
                $api = "https://demo.office24by7.com/CronJobs/longcode_service_api.php?";
                $api .= "client_Number=$sender&";
                $api .= "service_Number=$dest&";
                $api .= "smsinfo=$smsinf&";
               $api.="message=".urlencode($body)."&";
               $api.="senttime=".urlencode($stime);
               return file_get_contents($api);
...
/*
 function  call_strikersoft_longcode_api($sender,$dest,$body,$stime,$smsinfo){
	...
	function  call_waterboard_api($username,$password,$sender, $dest,$body,$stime){
...
/*
 function  call_tsrtc_api($sender,$body){
         ...
         function  call_tsrtc_api_test($sender,$body){
               $api = "https://www.smsstriker.com/idea/check.php?";
