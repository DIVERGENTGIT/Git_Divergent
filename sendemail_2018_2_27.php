					...
					//if($pgresponse=='Transaction Cancelled')
					 {
						 ...
						 $query1="INSERT INTO `user_payments` ( `user_id`, `no_of_sms`, `price`, `amount`, `service_tax`,
						 `service_tax_percent`, `total_amount`, `on_date`, `payment_type`, `transaction_id`)
						 VALUES ('$registeruser_id', '$noofsms', '$smsprice', '$amount', '$tax_amount', '$ServiceTax', '$total_amount','$on_date',1,$trn_id)";
