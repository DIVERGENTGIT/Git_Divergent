...
// send invoice email for sales added by niharika on 13-02-2017

function send_email_invoices($epg_txnID,$created_on,$registeruser_id,$smstype,$payment_id,$organization,$name,$username,$on_date,$no_of_sms,$price_per_sms,$amount,$ServiceTax,$service_tax,$total_amount,$pgresponse,$mobile,$email)
{
...
//$mail->AddReplyTo($email, $name); // indicates ReplyTo headers
//$mail->AddAddress($email, $name);
//mail->AddAddress("pasulaniharika@gmail.com", "SMSSTRIKER");
//$mail->AddBCC("supraja.thanga@smsstriker.in", "SMSSTRIKER");
//$mail->AddBCC("sales@smsstriker.com", "SMSSTRIKER");
//$mail->AddBCC("naveen@smsstriker.com", "SMSSTRIKER");
$mail->WordWrap = 50;
$mail->IsHTML(true);
$mail->Subject = "INVOICE Lead";
