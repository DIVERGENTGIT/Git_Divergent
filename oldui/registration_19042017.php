...
$usrexistquery=	mysqli_query($link,$sql);
$existornot=	mysqli_fetch_array($usrexistquery);
if($existornot['cnt']!=0)
{
	...
	organization,address1,address2,city_id,state_id,zipcode,mverify,shorturl_credits)
	values('$username','$password','$firstname','$lastname','$emailid',
	'$mobileno','$organization','$address1','$address2',$city_id,$state_id,$zipcode,'1','$shorturl_credits')";  
