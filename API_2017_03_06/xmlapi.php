...
error_log($data.$date."\r\n",3,"/var/www/vhosts/www.smsstriker.com/htdocs/api_log/xml-api.log");
                    ...
                    if($isDND){
                        ...
                        if($type=="0"){
                            $URL .="&mclass=0";
                   								...
                   								$URL .= "&dlr-mask=19&dlr-url=".urlencode("http://182.18.165.185/apidlr_xml.php?campaign_id=$smsId&smscID=%i&dlr=%d&answer=%A&to=%p&from=%P&ts=%T");
