...
$sql = $this->db->select("count(to_mobileno) as total_count,
		...
		$multiple_submit_count = $this->db2->query("SELECT count(*) as multiple_submit_count FROM $table_name WHERE dlr_status = 16 AND (error_code = 1077 OR error_code = 411 OR error_text = 'Duplicate Msg' ) AND user_id = '".$user_id."' AND date(ondate) = '".$ondate."'");     
		$array['multiple_submit_count'] = $multiple_submit_count->row('multiple_submit_count');
...
$sql = $this->db->select("count(to_mobile_no) as total_count,
		...
		$multiple_submit_count = $this->db->query("SELECT count(*) as multiple_submit_count FROM $table_name WHERE dlr_status = 16 AND (error_code = 1077 OR error_code = 411   OR error_text = 'Duplicate Msg'   ) AND campaign_id = '".$campaign_id."' ");     
		$array['multiple_submit_count'] = $multiple_submit_count->row('multiple_submit_count');
		...
		$multiple_submit_count = $this->db2->query("SELECT count(*) as multiple_submit_count FROM $table_name WHERE dlr_status = 16 AND (error_code = 1077 OR error_code = 411 OR error_text = 'Duplicate Msg' ) AND campaign_id = '".$campaign_id."'");     
		$array['multiple_submit_count'] = $multiple_submit_count->row('multiple_submit_count');
