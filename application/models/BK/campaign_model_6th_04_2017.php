...
function get_SMSCredits($userId)
	...
	*/
	...
	public function shorturl_reportssearch_newcount($userid)
	{
		  $query =  $this->db->query("SELECT campaigns.sms_text,campaigns.campaign_id,shorturl_text as long_url,created_on as date_created,RIGHT(shorturl_text, 7 ) AS short_code,phone_nos_count FROM sms.campaigns WHERE sms.campaigns.user_id = '".$userid."' AND sms.campaigns.shorturl_text != '' ORDER BY campaign_id desc ");  
