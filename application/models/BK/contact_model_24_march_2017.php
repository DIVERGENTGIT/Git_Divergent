...
//echo $this->db->last_query();
	...
	{
		$query =$this->db->query("select contact_id,group_id, name,dob,address,join_date,relieve_date, mobile_no,gender from contacts where  user_id=$user_id and group_id=$group_id");
//echo $this->db->last_query();
		return   $row = $query->result_array(); 
