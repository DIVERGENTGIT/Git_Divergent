...
return   $row = $query->result_array(); 
	...
	{
		$query = "select  distinct date(ondate) as ondate,sum(noofmessages) as noofmsg,message_id from sms_api_messages where user_id='$user_id' and ondate >= DATE_SUB(NOW(),INTERVAL 6 MONTH)";
