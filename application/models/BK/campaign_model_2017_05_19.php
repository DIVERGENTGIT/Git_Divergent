...
public function unassigncampainsvalues($mobile,$user_id,$reseller_id)
{
	...
	function createCustomizedCampaign($userId,$sms_type,$sms_text,$sender,$_sender,$total_no_of_sms,$is_schedule,$scheduled_date,$sms_port,$campaign_name,$shorturl_text,$shorturl_input,$total_mobile_no)
	{
		// calculate SMS length  
		if(strlen($sms_text)>160)
			$sms_length_tmp=ceil(strlen($sms_text)/153);
