...
return   $row = $query->result_array(); 
	...
	function get_SMS_API_Reports1($user_id,$mobileNum,$from_date,$to_date)
	{ 
...
function get_total_sms_api_days1($user_id,$mobileNum,$days_diff,$from_date,$to_date)
	...
	public function get_sms_api_details_filter_count($userID,$days_diff,$mobileNum,$fromDate,$toDate,$off_set,$limit) {
		...
		$records += $this->getAPIReports_filter_count($userID,$mobileNum,$days_diff,$fromDate,$toDate);
	  ...
	  function getAPIReports_filter_count($user_id,$mobileNum,$days_diff,$from_date,$to_date) {
		$response = 0;
		$year = substr($from_date,0,4);
		$month = substr($from_date,5,2);  
		$year1 = substr($to_date,0,4);
	...
	public function get_sms_api_details_filter($userID,$mobileNum,$days_diff,$fromDate,$toDate,$off_set,$limit) {
