								...
								if($shortInput) {
									...
									//} else {
										...
										if($is_duplicate){
											...
											$this->Campaign_model->campaignToNormalShorturl($campaign_id, $sendShorturl, $sms_length, $mobile_no, $message,$sms_port, 16, $error_text);
	...
	{ 
		...
		if($this->_data['selected_sms_type'] == 'ApiSms') {
			...
			if(!$mobileNum) {
				...
				$total_days = 2;//$this->Campaign_model->get_total_sms_api_days1($this->_userId,$mobileNum,$days_diff,$fd,$td);			  
 
  				$days_data = array();//$this->Campaign_model->get_sms_api_days1($this->_userId,$mobileNum,$days_diff,$fd,$td,$off_set,$limit);
