...
if($this->_userId == 3595)
{
	$sms_port = 20113;  
}

if($this->_userId == 4249)
{
	$sms_port = 21013;  
}    
   ...
   */
	...
	public function upload_file_data() { 
		...
		if($rs) {
			...
			$tab ="\t";
			$newline ="\n";
			$string .= "DateTime" . $tab . " ToMobileNo " . $tab . " No.ofSMS " . $tab . " SenderName " .  $tab . "Status" . $tab . " Message " .$newline;
		...
		foreach ($rs as $row) {
			...
			$string .= $createdDate .$tab. $toMobileNum .$tab. $numberOFSMS .$tab. $senderName .$tab; 
