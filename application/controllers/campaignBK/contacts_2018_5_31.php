...
$join_date = $this->input->post('join_date');
 ...
 //if client type is transactional, check for template if not dynamic
		...
		$this->_data['userid']=$this->_userId;
  		...
  		$this->_data['International'] = $this->_International; 
...
if($this->_userId==4130)
 ...
 $senderName_kennel = $sender;
	...
	//ADDED ON 2017-01-23
	  ...
	  $campaign_id = $this->Campaign_model->createContactShortUrlCampaign($this->_userId,$sms_type,$sms_text,$sender,$_sender,$total_no_of_sms,$is_schedule,$scheduled_date,$sms_port,$campaign_name,$shorturl_text,$shorturl_input,$total_numbers);
