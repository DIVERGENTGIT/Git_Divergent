...
$this->_data['shorturlCredits'] =  $rs->shorturl_credits;
            ...
            if ($this->form_validation->run('add_sender_name_form') == TRUE) {
                ...
                $sender_name = $this->input->post('sender_name');
               	if($this->user_model->isSenderNameAvailable($this->_userId, $sender_name))
               	{
                	...
                	redirect("index.php/mytemplate/sender_names/added");
                	
				}else
				{
					$this->_data['error'] = "Please follow the below errors"; 
					redirect("index.php/mytemplate/sender_names/exist");
				}
    ...
    public function delete_sender_name()
    {
        ...
        if(!$senderId){
            redirect('index.php/mytemplate/sender_names');
        }
        ...
        if(!$rs){
            redirect('index.php/mytemplate/templates');
        }

        $rs = $this->user_model->delete_sender_name($this->_userId, $senderId);

        redirect("index.php/mytemplate/sender_names/deleted");
    }
        ...
        if($this->input->post('add_template')){
            ...
            if($this->form_validation->run('add_template_form') == TRUE) {
                ...
                if($is_template_added == 1) {  
                 	...
                 	redirect("index.php/mytemplate/templates/added");
                  
                 }else if($is_template_added == 2){
			redirect("index.php/mytemplate/templates/edittemp");
		 }elseif($is_template_added == 3) {
			redirect("index.php/mytemplate/templates/notUnique");
		}elseif($is_template_added == 4) {
			redirect("index.php/mytemplate/templates/length");
		}else{
			redirect("index.php/mytemplate/templates/notAdded");
		}
              }else
            	{
			 $this->_data['error'] = "Please follow the below errors"; 
	...
	$config['base_url'] = site_url().'index.php/mytemplate/templates';
    ...
    public function delete_template()
    {
        ...
        redirect("index.php/mytemplate/templates/deleted");
    }
	...
	public function delete_campaign_template()
	{
		...
		if(!$campaignId){
			redirect('index.php/mytemplate/getRecentTemplate');
		}
		...
		redirect("index.php/mytemplate/getRecentTemplate/deleted");   
	}
