...
public function confirm_order()
	...
	if(!empty($_POST['flag']) && @$_POST['flag']!='')
		...
		echo $_SESSION['confirm_nos']=trim($str,',');
...
redirect($testssl_url);
     ...
     public function order_history(){
		...
		$_SESSION['trn_transid']=$this->input->post('trn_transid');
...
public function getuserforms()
	...
	//print_r($_REQUEST);
		...
		/**  get order number for session variable end **/
			...
			'mobileno'=>$mobileno,'user_id'=>$user_id,'did_numbers'=>$_SESSION['sel_nos']);
...
//print_r($this->_data['cart_num']);
	...
	public function otp_missedcall()
	{
	
	print_r($_POST);
	//$this->load->view('includes/header');	
	$this->load->view('missedcall_payments/otp-missedcall');	
	}
