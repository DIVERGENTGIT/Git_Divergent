...
$this->_data['error'] = $this->_data['no_balance'] = "Insufficient SMS Credits. Require {$deductCustomCredits} credits";
							...
							if($shorturl_input != NULL) {
							 ...
							 $campaign_id = $this->Campaign_model->createCustomizedCampaign($this->_userId,$sms_type,$sms_text,$sender,$_sender,$total_no_of_sms,$is_schedule,$scheduled_date,$sms_port,$campaign_name,$shorturl_text,$shorturl_input,$validMobileCount);  
