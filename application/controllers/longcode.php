...
public function renwaldedicated()
 ...
 values ($userid,$qty,$sms_price,$amount,$tax_amount,$total_amount,$transaction_id)";
		$this->db->query($query);
...
public function confirm_add_credits()
	...
	$this->session->set_userdata('total_amount','0');
        ...
        }else{ redirect ('longcode/add_credits'); }
...
redirect($testssl_url);*/
		...
		$sql="update price_enquery set transaction_id='$transaction_id'  where id in ($ids)";
		$this->db->query($sql);
		$longcode_credits = $this->session->userdata('qty');  
		$sms_price = $this->session->userdata('sms_price'); 
		$amount = $this->session->userdata('amount'); 
		$tax_amount = $this->session->userdata('tax_amount'); 
		$total_amount = $this->session->userdata('total_amount'); 
		...
		values ($userid,$longcode_credits,$sms_price,$amount,$tax_amount,$total_amount,$transaction_id)";
		$this->db->query($query);
		$this->encryptPaynow($gettotal_amount,$transaction_id);
