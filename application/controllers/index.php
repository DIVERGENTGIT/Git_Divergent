		...
		if($rs && $otpCode)
			{
				...
				{ 
 					...
 					$formatArr = explode(',',$otpMobileNo);
 					$formatArr = array_unique($formatArr);
 					$formatArr = array_filter($formatArr);  
 					$formatArr = array_values($formatArr);
				 	$otpMobileNo = implode(',',$formatArr);				
