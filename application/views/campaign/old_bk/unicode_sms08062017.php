...
<div class="form_error"><?php echo form_error('sms_text'); ?></div>
		...
		echo form_textarea(array("onKeyup" => "removeDuplicates();" ,'name' => 'to_mobileno', 'id' => 'to_mobileno', 'placeholder' => 'Mobile numbers (one number each line)', 'rows' => 7, 'cols' => 30, 'style' => 'padding:5px !important;', 'class' => 'form-control', 'value' => set_value('to_mobileno')));?>
