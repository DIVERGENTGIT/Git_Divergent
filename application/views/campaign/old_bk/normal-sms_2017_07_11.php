...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
<?php echo form_open('index.php/campaign/normalSMS',
...
<div class="form_error"><?php echo form_error('sender'); ?></div>
    ...
    <div class="col-sm-2 col-md-2 col-xs-12 tbresp-label padding_zero">
                   ...
                   <div class="col-sm-7 col-md-7 col-xs-12 tbresp-rt padding_mzero">
				    <div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
				   	<?php echo form_textarea(array('name' => 'sms_text', 'id' => 'sms_text', 'placeholder' => 'Type here', 'rows' => 4, 'cols' => 30, 'style' => 'margin-bottom:0px !important;', 'class' => '', 'value' => set_value('sms_text')));?>
...
function getGroupData(groupId) {
 	$.ajax({
		url:"<?php echo base_url();?>index.php/contacts/getGroupDetails",
		type:"post",
 ...
 <ul class="smsadmintabs">
    ...
    <div class="smsadmintabdiv">
		...
		<!--<form method="post"  name="add_group_form" id="addnew-group-valid" action="<?php echo base_url();?>contacts/addGroupData" enctype="multipart/form-data">-->
				<form method="post"   name="add_group_form" action="<?php echo base_url();?>index.php/contacts/addGroupData" id="addnew-group-valid" enctype="multipart/form-data">  
