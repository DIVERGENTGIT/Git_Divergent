...
<?php 
	...
	echo form_open('index.php/campaign/newVariableSMS',
...
$('#fileupload_error').text(''); 
	 ...
	 var formData = new FormData(document.getElementById("variable_sms_file_upload")); 
 	   $.ajax({
		url: "<?php echo base_url();?>index.php/campaign/uploadCustomSmsFile",
		type: "POST",
 		enctype: 'multipart/form-data',  
    		processData: false,  // tell jQuery not to process the data
   		 contentType: false,
...
function customizePreview() {   
	...
	///var formData = new FormData(document.getElementById("variable_sms_file_upload")); 
	$.ajax({  
		url: "<?php echo base_url();?>index.php/campaign/customizePreview",
		type: "POST",
		//enctype: 'multipart/form-data',  
		//processData: false,  
		//contentType: false,    
