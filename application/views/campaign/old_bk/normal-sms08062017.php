...
echo form_textarea(array("onKeyup" => "removeDuplicates();" ,'name' => 'to_mobileno', 'id' => 'to_mobileno', 'placeholder' => 'Mobile numbers (one number each line)', 'rows' => 7, 'cols' => 30, 'class' => 'form-control', 'style' => 'padding: 5px !important;', 'value' => set_value('to_mobileno')));?>
</div>
