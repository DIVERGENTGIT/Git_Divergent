...
<div class="col-md-12 col-xs-12 col-sm-12 padding_zero">
 ...
 <div class="col-md-12 col-xs-12 col-sm-12 form-div padding_zero">
   ...
   File Format :  <?php echo  form_dropdown('file_format', $file_type_options , 'all' ,'class="selectText"');?> &nbsp;<?php */?>
    ...
    //Array ( [total_count] => 237 [pending_dlr_count] => 213 [delivered_count] => 5 [expired_count] => 12 [invalid_count] => 6 [invalid_nos_count] => 24 [multiple_submit_count] => 0 [invalid_number_length_count] => 0 [misc_error_count] => 0 [invalid_sender_ids_count] => 0 [dnd_count] => 0  [out_of_range_count] => 0 [memory_capacity_exceeded_count] => 0 [mobile_equipment_error_count] => 0 [network_error_count] => 0 [barring_count] => 0 [promo_blocked_count] => 0 )
			$dnd_count= $dlr_report['dnd_count'];
			$delivered_count= $dlr_report['delivered_count'];
			$invalid_nos_count= $dlr_report['invalid_count'];  
			...
			$account_expired_count= $dlr_report['expired_count'];
