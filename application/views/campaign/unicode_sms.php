...
<h3 class="right-content-title"><img src="<?php echo base_url();?>images/sms-icon.png" class="right-title-img">Unicode SMS</h3>
</div>
...
<?php //if(!empty($no_balance)){ echo $no_balance;}?>  
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
			            	...
			            	<?php echo form_open('campaign/unicodeSMS',
					array('id' => 'single_sms_form', 'name' => 'single_sms_form', 'class' => 'missedcall_allform', 'method' => 'post')
	); ?> 
...
-->
	  	...
	  	<?php echo form_dropdown('sender', $sender_names, set_value('sender'),array('style'=>'', 'class'=>''));?> 
                 ...
                 <div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
    <div class="col-sm-2 col-md-2 col-xs-12 tbresp-label padding_zero">
                    <label class="form_lable">Type in </label>
					</div>
                  <div class="col-sm-7 col-md-7 col-xs-12 tbresp-rt padding_mzero">
					<div id='translControl'>
      <div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
	  			<div class="all_checkbox">
<input type="checkbox"  id="checkboxId" onClick="javascript:checkboxClickHandler()" checked="checked" >
  <label class="font_normal" for="checkboxId"><span><span></span></span>Type in</label>
</div>
	  
      </div>
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero"> 
<select id="languageDropDown" style="margin:0px;" onChange="javascript:languageChangeHandler()">
...
<div class="col-md-12 col-sm-12 col-xs-12 form-divadd add-btns-div padding_zero">
				...
				<input type='hidden' id="transl1"/>
				   	<?php echo form_textarea(array('name' => 'sms_text', 'id' => 'sms_text', 'placeholder' => 'Type here', 'rows' => 4, 'cols' => 30, 'class' => 'form-control', 'style' => 'padding:5px !important;', 'value' => set_value('sms_text')));?>
...
<div class="form_error"><?php echo form_error('sms_text'); ?></div>
		...
		echo form_textarea(array('name' => 'to_mobileno', 'id' => 'to_mobileno', 'placeholder' => 'Mobile numbers (one number each line)', 'rows' => 7, 'cols' => 30, 'style' => 'padding:5px !important;', 'class' => 'form-control', 'value' => set_value('to_mobileno')));?>
...
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
	...
	<div class="col-sm-7 col-md-7 col-xs-12 col-md-offset-2 mrg20tab padding_mzero col-md-offset-2">
                 <div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
				  <div class="col-md-6 col-sm-6 col-xs-6 numwfull padding_zero">
						<div class="all_checkbox">
...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero"> 		
  ...
  <div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
                 ...
                 <div class="col-sm-7 col-md-7 col-xs-12 col-md-offset-2 col-md-offset-2 mrg20tab padding_mzero">
  ...
  <input type="hidden" name="shorturl_input" id="shorturl_input" />  
	    <input type="hidden" name="shorturl_text" id="shorturl_text"  />
							...
							'class' => 'submit_btn','data-placement' => 'top','style' => ''));?>
 	  <?php //echo form_reset(array('name' => 'reset','value' => 'Reset', 'class' => 'submit_btn mrg2px','data-placement' => 'top','style' => '')); ?>
                    </div>
                </div>
...
,
 ...
 userfile: {
            required: "Please Upload XL,XLSX Types"            
        },
 contact_name: {  
...
$('#sms_text').val($('#sms_text').val() + e.target.value+'\n');		
 ...
 <?php if($isInternational == 1) { $maxLength = 20;} else { $maxLength = 10; }; ?>
 <script>
...
$('#to_mobileno').on('input focus keydown keyup', function() {
    ...
    $(this).val(lines.join(''));
	 ...
	 $(document).ready(function(){
      $('#sms_text2').bind("cut copy paste",function(e) {
...
$('#relieve_date').datepicker( {
       ...
       //$("#to_date").datepicker("option", 'minDate', selectedDate);
                $("#join_date").datepicker("option", 'maxDate', monthsAddedDate);
            }
    }).click(function(){
