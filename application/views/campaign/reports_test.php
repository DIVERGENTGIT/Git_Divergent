...
.select_01 select{    padding: 0px 5px !important;
  ...
  <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>campaign/viewcampaignssearch/" name="campaign_search" id="campaign_search" method="post" >
...
<td style="width:200px !important important;">  <p class="row-fluid alert alert- alert-dismissable " data-toggle="tooltip" data-placement="bottom" title="" 
  ...
  data-original-title="<?php echo $campaign->sms_text; ?>" >
<?php	 
