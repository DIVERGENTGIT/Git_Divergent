...
<h3 class="right-content-title"><img src="<?php echo base_url();?>images/reports-icon.png" class="right-title-img">Bulk Url Reports</h3>
</div>
...
?>
	...
	<tr style="height:30px !important;" > 
		...
		<td><?php echo $shorturl->shorturl; ?></td> 

		<td><a href="<?php echo base_url(); ?>campaign/shortCodeReports/<?php echo $shorturl->shortCode; ?>"><?php echo ($shorturl->counter)?$shorturl->counter:'0';   ?></a></td>
	...
	<div class="col-md-12 col-sm-12 col-xs-12 padding_zero"  class="pagination" style=" float:left; background-color:transparent !important; border:none !important; box-shadow:none !important;">
