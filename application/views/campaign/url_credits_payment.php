...
$( document ).ready(function( $ ) {
	var trn_id=  "<?php echo $_REQUEST['tn']?>";
       ...
       var urlvar="<?php echo base_url(); ?>API/shorturl/invoice_addcredits.php?payment=payment&trn_id="+trn_id+"&servicetax="+servicetax+"&tax="+tax+"&smsprice="+smsprice;
...
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding-zero">
<div class="col-sm-3 col-md-3 col-xs-12 padding-zero">
<label class="form_lable">No of url</label>
</div>
<div class="col-sm-7 col-md-7 col-xs-12  padding-ltzero padding-mzero">
<?php 
	echo $number_of_url;
...
<input type="hidden" name="qty" value="<?php echo $number_of_url;?>">
...
<input type="hidden" name="sms_price" value="<?php echo $priceper_sms;?>">
<input type="hidden" name="smstype" value="<?php echo $usertype;?>">
<input type="hidden" name="shorturl_credits" value="<?php echo $number_of_url;?>">
<input type="hidden" name="description" value="Add Shorturl Credits">
