 ...
 <ul class="addshorttabs">  
  ...
  <!-- Updated ON 2017-02-4 -->
        ...
        <li><a href="<?php echo base_url();?>campaign/bulkshortUrlvideo">Video Short URL</a></li>
         <li class="currentshorttab"><a href="<?php echo base_url();?>campaign/bulkshortUrlaudio">Audio Short URL</a></li> 
          
    </ul>     
    <div class="smsadmintabdiv">
       		  <form action="<?php echo base_url();?>campaign/bulkshortUrlaudio" id="shorturlaudio_valid" method="post"> 
        <div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
...
<div class="fileUpload btn submit_btn">
    ...
    <input id="file_input" name="file_input" type="file" onChange="upload_audio();"  class="upload" />
</div> 
 <p id="uploaded_img"> </p>	
</div> 
<div class="col-md-9 col-sm-12 col-xs-12 padding_zero">
				 <ul class="note-list02">
<li>Please upload mp3 filetypes and size must be less than 2MB.</li>
</ul>
 </div>
<!-- <input type="submit" onClick="upload_image();" class="submit_btn upload-mrg"  value="Upload"> -->
		...
		<div class="col-md-6 col-sm-6 col-xs-12 padding_zero">
         <input type="text" id="short_url_image" name="shorturl" placeholder="Your Short URL" readonly class="shorturl-txt short-mrg01 form-div">
...
$("#shorturlaudio_valid").validate({
	...
	messages: {
		...
		shorturl: {
            required: "You will get Short url after upload an Audio"            
        },
	...
	var urlCredits = "<?php echo $shorturlCredits;?>"; 
  	if(urlCredits > 0) {
		...
		if(size > 2){
			...
			var formData = new FormData(document.getElementById("shorturlaudio_valid")); 
			$.ajax({
	    ...
	    window.location.href = "<?php echo base_url();?>campaign/bulkshortUrlaudio/noCredits";
        } 
}
</script>
