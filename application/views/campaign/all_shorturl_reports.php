...
<tr>
		...
		<td><p data-toggle="tooltip" data-placement="bottom" title="<?php echo wordwrap($shorturl['sms_text'], 150,'..'); ?>" class="wordwraptxt line_wrapreport"><?php echo wordwrap($shorturl['sms_text'], 150,'..'); ?></p></td>
