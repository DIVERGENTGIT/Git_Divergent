...
<html>
  <head>
    ...
    <!-- Theme style -->
    <!--<link href="sdist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />-->
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="col-md-12 ng-scope" data-ng-controller="formConstraintsCtrl" style="padding:0px;">
        ...
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> Customized SMS</strong></div>
         ...
         <tr>
   <td  >
   <a class="btn btn-file btn-app alert-info" style=" width:130px;">
                    <i class="fa fa-file-text-o "></i> <input  type="file" name="attachment">Choose File
                  </a>
                 
                  
                 <a href="customized-sms.php" class="btn btn-file btn-app alert-info" style="width:130px; margin-top:20px;">
