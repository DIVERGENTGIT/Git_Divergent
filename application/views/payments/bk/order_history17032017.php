...
<h3 class="right-content-title"><img src="<?php echo base_url();?>images/analytics-icon.png" class="right-title-img">Order History</h3>
</div>
...
<div class="col-sm-3 col-md-3 padding_rtzero form-div padding-memty col-xs-12">
<select name="trn_service" class="form-control"><option value="">Select Status</option>
...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
         ...
         ?>
					 ...
					 // echo $product['payment_status'];
                      ...
                      ?>
                       ...
                       <td>
                       <a href="<?php echo base_url(); ?>Payment/order_details/<?php echo $product['epg_txnID'] ?>" ><input type ="button" class="submit_btn" value ="View" /></a>
</td>
                        <td>
 ...
 <input type ="button" class="submit_btn" value ="Invoice" /></a>
  <?php 
  if($product['payment_status']=='Transaction Successful')
