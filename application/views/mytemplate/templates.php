...
<div class="col-md-7 col-sm-8 col-xs-12 padding_mzero">
                      <?php echo form_textarea(array('name' => 'template', 'onKeyup' =>"calculateSMSLength()",  'id' => 'template', 'value' => set_value('template'), 'class'=> 'form-textarea', 'placeholder'=> 'Type here', 'rows'=>'8')); ?>
