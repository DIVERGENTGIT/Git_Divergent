...
<li>
<input type="text" id="from_date" name="from_date" value="<?php echo $from_date; ?>" class="data-pickerbg">
</li>
<li>
<input type="text" id="to_date" name="to_date" value="<?php echo $to_date; ?>"  class="data-pickerbg">
</li>
...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
 <a style="float: right;" href="<?php echo base_url();?>mytemplate/getRecentTemplate/download" class="bt_green"><span class="submit_btn">Download</span></a> 
    </div> 
<?php //} ?>	
