      ...
      <div class="content-wrapper">
        ...
        <section class="col-sm-12 col-md-12 col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> Messages</strong></div>
	    ...
	    <li><a href="<?php echo base_url(); ?>missedcall/index">Missed Calls</a></li>
      
	    <li class="active"><a href="<?php echo base_url(); ?>missedcall/messages">Masseges</a></li>
...
Search</button>
 ...
 <div class="col-sm-12">
  <div class="box"  style="margin-top:10px;     border-top:0px !important;">
        ...
        <th class="sendee-color" style="text-align:center; "> Messaged To</th>
        <th class="sendee-color" style="text-align:center; ">Message From</th>
        <th class="sendee-color" style="text-align:center; width:100px !important; important;">Message</th>
        <th class="sendee-color" style="text-align:center; width:100px !important; important;">Message Date</th>
        </tr>
...
<td style="width:50px!important;"><?php echo $smsreport->message_from; ?>
</td>
