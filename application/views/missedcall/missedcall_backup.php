...
#example1_filter input[type="search"]{    padding: 5px 10px !important;
  ...
  <div class="col-sm-9 col-md-9 col-xs-12 padding_zero">
      ...
      <div class="content-wrapper">
        ...
        <section class="col-sm-12 col-md-12 col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> Missed Calls</strong></div>
	    ...
	    <li class="active"><a href="<?php echo base_url(); ?>missedcall/index">Missed Calls</a></li>
   ...
   <div>
  <form class="form-horizontal col-sm-12" role="form" action="<?php echo base_url(); ?>./missedcall/index/" name="campaign_search" id="campaign_search" method="post" >
...
<div class="box"  style="margin-top:10px;     border-top:0px !important;">
       ...
       <tr style="text-align:center; height:30px !important; ">
        ...
        <th class="sendee-color" style="text-align:center; "> Dialled Number</th>
        <th class="sendee-color" style="text-align:center; ">Called From</th>
        <th class="sendee-color" style="text-align:center; width:100px !important; important;">Called Date</th>
        </tr>
                    </thead>
                    <tbody>
