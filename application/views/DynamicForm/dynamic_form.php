...
<div class="col-sm-12 DynamicForm_sms_tabs padding_zero">
		<ul class="jtab-trigger jtab-ul">
			...
			<li>
				<a href="<?php echo base_url(); ?>DynamicForm/getList">Dynamic Form Lists</a>
			</li>
			
			<li>
				<a href="<?php echo base_url(); ?>DynamicForm/Reports">Dynamic Form Reprts</a>
			</li>
		</ul>
	</div>
...
<div class="jtab-content-list col-xs-12 col-sm-12">
	...
	{?>
    <li>
        <a href="<?php echo base_url(); ?>DynamicForm/dyn_form/<?php echo $dynamic['form_name']?>" class="jtab-selected"><?php echo $dynamic['form_name']?></a>
    </li>
<?php }?>
