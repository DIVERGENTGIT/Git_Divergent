...
window.self.location="<?php echo base_url();?>index.php/myaccount/index";
</script>
	<?php
		unset($_SESSION['otp']);			
			unset($_SESSION['end']);
...
<!--
  ...
  --> 
   ...
   <p class="otpmsg" style="text-align: center;margin-top: 14px;">Check for OTP code which will be valid for 2 mins Only.</p>
    
    <form action="<?php echo base_url();?>index.php/myaccount/codeotp_mverify" method="post" class="col-sm-12" style="margin-top:17px;">
...
-->
   ...
   <input type="button"  class="submit_btn resendotp" value="Resend">
...
var count=0;
	...
	count++;
				...
				$.ajax({
				type:"GET",
				url:"<?php echo base_url()?>index.php/myaccount/resend_otp",
				data:{},
      ...
      $(".otpmsg").html("Your otp sent to E-Mail & Mobile!.");
	$(".otpmsg").css("color","green");
	
	}
	else
	{
	$(".otpmsg").html("you have exceeded maximum times.Please try again!.");
