...
session_start();
 ...
 $verify=str_replace(' ','',$_REQUEST['otpcode_check']); // this step is to remove white spaces from input
		...
		$description=$_SESSION['description'];
		 $url="http://www.smsstriker.com/payment/TestSsl.php?amount=".$amount."&name=".$name."&trnsale=".$trnsale."&customerid=".$customerid."&address1=".$address1."&address2=".$address2."&address3=".$address3."&city=".$city."&state=".$state."&email=".$email."&cname=".$cname."&desc=".$description."&mobile=".$mobile ."&zip=".$zip ;
