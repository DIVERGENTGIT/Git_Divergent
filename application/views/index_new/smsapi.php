	...
	<div class="section subbanner col-sm-12">
		<div class="container">
			<div class="row">
				...
				<h2 class="lead col_or">SMS API</h2>
				</div>
...
<div class="col-sm-12 mrg_top col-md-12 padding_zero">
	...
	<img src="<?php echo  base_url(); ?>images_n/long-code.png" alt="logo" >
				...
				<div class="col-sm-12 padding_zero services-item-full">
					<div class="col-xs-12 padding_ltzero col-md-6">
						<div class="desc-wrap">
