...
<body>
	...
	<div class="section subbanner col-sm-12">
		<div class="container">
			<div class="row">
				...
				<h2 class="lead col_or">Feedback Form</h2>
				</div>
	...
	<div id="services" class="section services">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 mrg_015">
					<div class="feedback_form">
					<div class="col-sm-12 reg_page01">
				
					<div class="col-sm-12 reg_pageheader">
					 
			<h4>Feedback Form</h4>
           </div>
			<form name="feedback_form" method="post" id="feedback01_form" class="form-horizontal">
			<div class="col-sm-12 reg_pagebody">
			<input type="text" name="name" class="form-control" placeholder="Enter Your Name">
			<input type="text" name="contact_number" class="form-control" placeholder="Enter Your Phone Number" id="pohone_no">
			<input type="text" name="contact_email" placeholder="Enter Your Email" class="form-control">
		<input type="text" name="contact_subject" placeholder="Enter Your Subject" class="form-control">
		 <textarea name="comment" class="form-control" placeholder="comment"></textarea>
			<div class="col-sm-12">
			<input type="submit" name="feedback" value="submit"></div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="footer-item">
							<div class="footer-logo">
								<img src="<?php echo  base_url(); ?>images_n/footer_logo.png" alt="flogo" />
							</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        ...
                        <div class="footer-item">
                           ...
                           <ul>
                              ...
                              <li type="button" class="list-group-item"><a href="sms-service.html"> <span class="f_sp">&#9830;</span>  SMS Service</a></li>
