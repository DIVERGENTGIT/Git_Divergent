...
<div id="newgroup" class="col-sm-12 col-md-12 col-xs-12 smsadmintab-content padding_zero">
<form id="createGroup" class="col-md-12 col-sm-12 col-xs-12 padding_zero missedcall_allform05" method="post" action="<?php echo base_url();?>contacts/addGroupData" enctype="multipart/form-data">
...
<div id="existinggroup" class="col-sm-12 col-md-12 col-xs-12 smsadmintab-content padding_zero" style="display:none;">
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-sm-12 col-md-6 col-xs-12 padding_ltzero">
<form method="POST" class="missedcall_allform" id="group_sms" action="<?php echo base_url(); ?>contacts/sendGroupSMS">
...
foreach($groups as $group=>$groupname):
 ...
 <input class="#Send-group" id="group_<?php echo $groups_count; ?>" type="checkbox"  name="groups[]" value="<?php echo $groupname->group_id;?>"   >  
  ...
  <a href="#" onClick="DoAction(<?php echo $groupname->group_id;?>,<?php echo $userid; ?>), DoActionGroup(<?php echo $groupname->group_id;?>,<?php echo $userid; ?>)"><?php echo $groupname->group_name; ?></a></label>
</div>
...
<div class="callout bg-info">
	...
	<div class="col-md-7 col-md-7 col-xs-12">
		<select name="gid" class="form-control" data-style="btn-info">
		<?php foreach($groups as $group1=>$groupname1):
		?>
		<option value="<?php echo $groupname1->group_id; ?>">
		<?php echo  $groupname1->group_name; ?> 
...
<?php echo form_open('contacts/sendGroupSMS', array('id' => 'group_sms_form', 'name' => 'group_sms_form', 'method' => 'post','class'=>'form-horizontal ng-pristine ng-valid')
	); ?> 
...
function DoAction(id,uid)  
{
    ...
    $.ajax({
         type: "POST",
         url: "<?php echo base_url(); ?>contacts/contact_list_ajax",
		  dataType: "html",
         data: {id:id,uid:uid},
