...
echo form_open('index.php/contacts/sendGroupSMS', array('id' => 'single_sms_form', 'name' => 'single_sms_form', 'class' => 'missedcall_allform', 'method' => 'post', 'style' => 'margin:0px !important')
); ?>   
