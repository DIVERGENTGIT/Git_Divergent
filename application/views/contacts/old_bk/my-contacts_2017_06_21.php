...
<div class="col-sm-4 col-md-4 col-xs-12 padding_ltzero">
		<input type="text" name="mobileNum" id ="mobileNum"  placeholder = "Mobile Number" value="<?php if(isset($mobileNum)) { echo $mobileNum;}?>">  
</div>
...
<form method="POST" class="missedcall_allform" id="group_sms" action="<?php echo base_url(); ?>index.php/contacts/sendGroupSMS">
