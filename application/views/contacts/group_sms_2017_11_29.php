...
echo form_open('contacts/sendGroupSMS', array('id' => 'single_sms_form', 'name' => 'single_sms_form', 'class' => 'missedcall_allform', 'method' => 'post', 'style' => 'margin:0px !important')
); ?>   
...
<div class="check"></div>
 ...
 <label class="form_lable">Campaign Name</label>
                    ...
                    <div class="col-sm-7 col-md-7 col-sm-12 tbresp-rt padding_mzero">
...
<div class="col-sm-2 col-md-2 col-xs-12 tbresp-label padding_zero">
 ...
 <div class="col-sm-7 col-md-7 col-xs-12 padding_mzero tbresp-rt sender_id01">
...
<div class="form_error"><?php echo form_error('sender'); ?></div>
    ...
    <div class="col-sm-2 col-md-2 col-xs-12 tbresp-label padding_zero">
                   ...
                   <div class="col-sm-7 col-md-7 padding_mzero tbresp-rt col-xs-12">
				    <div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
				   	<?php echo form_textarea(array('name' => 'sms_text','onKeyup' =>"calculateSMSLength()", 'id' => 'sms_text', 'placeholder' => 'Type here', 'rows' => 4, 'cols' => 30, 'style' => 'margin-bottom:0px !important;padding: 5px !important;', 'class' => '', 'value' => set_value('sms_text')));?>
...
<input type="hidden" name="shorturl_input" id="shorturl_input" />  
 ...
 <input type="hidden" name="selected_groups" value="<?php echo $groups;?>">
...
<div class="col-md-12 col-sm-12 col-xs-12">
 <ul class="addshorttabs">
        <li class="currentshorttab">
		<a href="#shorturltb">Web Short URL</a></li>
