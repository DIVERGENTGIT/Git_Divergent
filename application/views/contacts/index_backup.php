...
.tabbable{ background-color:#ccc;}
.tabbable ul li{ border:0px !important; line-height:40px;}
...
.nav-tabs{ border:0px !important; border:1px; }

.nav-tabs>li>a {
margin-right:6px 0px 0px 2px;
line-height: 26px;
padding:3px 15px;
...
.nav-tabs>li>a:hover {
background-color: #dcedff !important; color:#215a94 !important; border-color:#fff !important;}
.nav-tabs>li.active>a, .nav-tabs>li.active>a:focus, .nav-tabs>li.active>a:hover{ background-color: #d0e7ff !important;}


.modal-body {
position: relative;
padding: 0px 10px !important; background-color: 
}
.checkbox{ display:inline block; position:relative; margin-top:40px; z-index:1000; }


.active22 a{color:#215a94; background-color:#d0e7ff;}

.table>tbody>tr>td a{color:#222; font-size:13px; padding:6px; background-color:#; padding:6px; border-radius:4px; }
.table>tbody>tr>td a:hover{color:#555; font-size:13px; background-color:#EDF1F2; padding:6px; border-radius:4px;}

<!--right-box-->
.additional-menu .table>tbody>tr>td a {background-color:transparent !important;}
.additional-menu> .table>tbody>tr>td a:hover {background-color:transparent !important; color:#555;}
.bg-default-1{background-color:#edf1f2; border:1px solid #D0D0D0 !important; color:#989898 !important; foant-weight:none !important;}
.bg-default-1 span:hover{color:##3c8db !import_request_variables; border:1px solid #3c8db !important;}

.td input[type=radio] 
{
  margin: 4px 20px !important important;
...
<div class="col-md-8 ng-scope" data-ng-controller="formConstraintsCtrl" style="padding-left:0px; padding-top:40px;" >
...
<div class="input-group col-md-4" style="float:left; margin-left:20px;  line-height:30px; color:#009BFA; ">
<strong><span class="glyphicon glyphicon-th"></span> My Contacts</strong>    
</div>

<div class="panel-heading" style="float:left; padding:6px 0px; background-color:#;  " >

<div class="input-group col-md-4" style="float:left; ">
<input type="text"style="	bottom:2px; " name="message" placeholder="Serch Contacts ..." class="form-control">
<span class="input-group-btn">
<button type="button" style=" bottom:2px;"  class="btn btn-default btn-flat">Serch</button>
</span>
</div>

<div class="input-group col-md-4 horizontal" style="float:left;  padding:0px; " >
...
<span  class="col-md-6 col-xs-6 col-sm-6"style=" line-height:34px; color:#fff; background-color:#9E9E9E; font-weight:400; font-size:16px;padding:px;"><span class="col-md-1 col-xs-1 col-sm-1" style=" margin-left:8px; margin-top:7px;"><input type="checkbox" class="checkbox" checked="checked"/>


</span> &nbsp; All Groups &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <button type="submit" data-toggle="modal" data-target="#Send-Group" class="btn btn-default btn-sm">Send Group SMS</button>
</span> 
