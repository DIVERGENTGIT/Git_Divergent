...
<div class="col-md-12 col-sm-12 col-xs-12 form-div padding_zero">
 <div class="col-md-2 col-sm-2 col-xs-12 padding_zero">
			        	...
			        	<?php }else{ ?>
			        		<input type="text" id="contcat_mobileno" maxlength = 10 name="contcat_mobileno" placeholder="Enter Mobile Number">
			        	<?php } ?>
        ...
        <div class="col-md-7 col-md-7 col-xs-12">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 padding_zero">
			         ...
			         <div class="col-md-7 col-md-7 col-xs-12">
			        	...
			        	<?php }else{ ?>
			        		<?php echo form_input(array('name' => 'contcat_mobileno', 'maxlength' => 10, 'id' => 'contcat_mobileno', 'class' => 'form-control', 'value' => set_value('contcat_mobileno')));?>
			        	<?php } ?>
