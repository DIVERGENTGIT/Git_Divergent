...
<input type="text" name="captcha" id="captchacode" maxlength="10" minlength="5" class="form-registration registration-submit" placeholder="Enter Captcha Code">
</div>
...
<input type="button" name="registration" class="sms-first-form form-registration registration-submit" id="registration" value="Registration">
							...
							success:function(response1)
							{
								...
								if(response1.color=='green')
									...
									$.ajax({
										...
										state_id:state_id,city_id:city_id,pincode:pincode,paynow:"paynow",id:id},
										success:function(response)
										{
											console.log(response);
												if(response.code=='1'){
