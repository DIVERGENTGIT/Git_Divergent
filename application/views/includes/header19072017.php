...
<li><a href="<?php echo base_url(); ?>index.php/myaccount/index">My Profile</a></li>

<li><a href="<?php echo base_url(); ?>index.php/myaccount/myprice">My Price</a></li>

<li><a href="<?php echo base_url(); ?>index.php/myaccount/changepassword">Change Password</a></li>

 

<li><a href="<?php echo base_url(); ?>index.php/logout"><span class="spanlogout">Logout</span></a></li>
</ul>
