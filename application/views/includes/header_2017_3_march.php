...
<div class="col-sm-3 col-md-3 col-xs-12 padding_lrt0 logo_header">
      ...
      <a href="#myModal" class="logo-padding" data-toggle="modal">  <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="<?php echo base_url(); ?>images_n/logo.png" style="margin-top: 15px;"></span>
        </a>
        
       <?php else: ?>
           <a href="<?php echo base_url(); ?>index.php/campaign/normalSMS" class="logo-padding">
...
<li><a href="<?php echo base_url(); ?>logout"><span class="spanlogout">Logout</span></a></li>
</ul>
...
<img src="<?php echo base_url(); ?>images-new/bottomarrow.png" class="bottomarrow" data-toggle="collapse" data-target="#topmenuacc">
        ...
        <marquee class="marquee_class">Promotional messages should be send between 9:00Am to 9:00Pm only.</marquee>
        <?php endif;?>
        </div>
        
        <div class="col-sm-4 col-md-4 col-xs-12 sms_avb2" style="text-align: right;padding-right: 6px;">
<?php 
