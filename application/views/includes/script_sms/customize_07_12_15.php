...
var chart;
	 ...
	 var chartDatacust3 = [
                {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[0]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[0]['daywise'];
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[0]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[1]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[1]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[1]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[2]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[2]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[2]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[3]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[3]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[3]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[4]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[4]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[4]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[5]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[5]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[5]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[6]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[6]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[6]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[7]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[7]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[7]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[8]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[8]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[8]['daywise']))
					{ 
				...
				echo "0";
                 ...
                 {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[9]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[9]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[9]['daywise']))
					{ 
                ...
                {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[10]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[10]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[10]['daywise']))
					{ 
                ...
                {
                    "yearcust": "<?php if(!empty($getYearCampaignCustomized[11]['daywise']))
					{ 
					
				$monthNumunicode  = $getYearCampaignCustomized[11]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNumunicode);
				echo $monthNameunicode = $dateObj->format('F'); 
				...
				echo "0";
					...
					?>",
                    "nmyrcust": "<?php if(!empty($getYearCampaignCustomized[11]['daywise']))
					{ 
