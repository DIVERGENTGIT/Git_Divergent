...
<script> var chart;
     ...
     var chartData = [
            ...
            var chartData2 = [
                ...
                },
                {
                    ...
                    "num": <?php if(!empty($monthcampaignsquick_report[24]['totalmsg'])){ echo $monthcampaignsquick_report[24]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "month": "<?php if(!empty($monthcampaignsquick_report[25]['daywise'])){ echo $monthcampaignsquick_report[25]['daywise']; }else{ echo "0";}?>",
                ...
                {
                    "month": "<?php if(!empty($monthcampaignsquick_report[28]['daywise'])){ echo $monthcampaignsquick_report[27]['daywise']; }else{ echo "0";}?>",
	 ...
	 var chartData3 = [
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[0]['daywise']))
					{ 
				...
				echo "0";
					...
					?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[0]['totalmsg'])){ 
                ...
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[1]['daywise'])){ 
				...
				echo $monthName = $dateObj->format('F'); 
                    ...
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[1]['totalmsg'])){ 
					
					echo $yearcampaignsquick_report[1]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[2]['daywise'])){ 
$monthNum  = $yearcampaignsquick_report[2]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 					
					 }else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[2]['totalmsg'])){ 
					echo $yearcampaignsquick_report[2]['totalmsg'];
					
					 }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[3]['daywise'])){
						
					$monthNum  = $yearcampaignsquick_report[3]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 
						 }else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[3]['totalmsg'])){ echo $yearcampaignsquick_report[3]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[4]['daywise'])){ 
$monthNum  = $yearcampaignsquick_report[4]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 					
					}else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[4]['totalmsg'])){ echo $yearcampaignsquick_report[4]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[5]['daywise'])){
				...
				echo $monthName = $dateObj->format('F'); 
                    ...
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[5]['totalmsg'])){ 
					echo $yearcampaignsquick_report[5]['totalmsg']; 
					
					}else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[6]['daywise'])){ 
					$monthNum  = $yearcampaignsquick_report[6]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 
					 }else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[6]['totalmsg'])){ echo $yearcampaignsquick_report[6]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[7]['daywise'])){ 
					$monthNum  = $yearcampaignsquick_report[7]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 
					}else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[7]['totalmsg'])){ 
					echo $yearcampaignsquick_report[7]['totalmsg']; 
					
					}else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[8]['daywise'])){ 
				...
				echo $monthName = $dateObj->format('F'); 
                    ...
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[8]['totalmsg'])){ echo $yearcampaignsquick_report[8]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[9]['daywise'])){ 
				$monthNum  = $yearcampaignsquick_report[9]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 
					
					}else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[9]['totalmsg'])){ echo $yearcampaignsquick_report[9]['totalmsg']; }else{ echo "0";}?>
                },
                {
				...
				echo $monthName = $dateObj->format('F'); 
                    ...
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[10]['totalmsg'])){ echo $yearcampaignsquick_report[10]['totalmsg']; }else{ echo "0";}?>
                },
                {
                    "year": "<?php if(!empty($yearcampaignsquick_report[11]['daywise'])){ 
				$monthNum  = $yearcampaignsquick_report[11]['daywise'];
				$dateObj   = DateTime::createFromFormat('!m', $monthNum);
				echo $monthName = $dateObj->format('F'); 
					
					 }else{ echo "0";}?>",
                    "nmyr": <?php if(!empty($yearcampaignsquick_report[11]['totalmsg'])){ echo $yearcampaignsquick_report[11]['totalmsg']; }else{ echo "0";}?>
                }
