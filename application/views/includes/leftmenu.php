...
<nav class="navbar navbar-default custom-menu">
  <div class="container-fluid padding-zero">
    ...
    <div class="padding-zero collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <?php if($this->session->userdata('user_id')== 4857 || $this->session->userdata('user_id')==4904 ) { ?>
   	 <li><a class="<?php if($this->uri->segment(1)=='ftpcampaign' && $this->uri->segment(2)=='viewcampaigns') { echo 'activelink';}?>" href="<?php echo base_url();?>ftpcampaign/viewcampaigns">FTP Reports</a></li> 
      <li><a class="<?php if($this->uri->segment(1)=='ftpcampaign' && $this->uri->segment(2)=='misreports') { echo 'activelink';}?>" href="<?php echo base_url();?>ftpcampaign/misreports">Campaign Reports</a></li>

     
     <?php }else if($this->session->userdata('user_id')== 5742 || $this->session->userdata('user_id')== 5741 || $this->session->userdata('user_id')== 5740 || $this->session->userdata('user_id')== 5739) { ?>  
	...
	<li><span class="submenuli collapsed<?php if($this->uri->segment(2)=='misreports' || $this->uri->segment(2)=='api_misreports' ) { echo 'in leftmenutoggle';}?> " data-toggle="collapse" data-target="#misreports"><img src="<?php echo base_url();?>images/reports-icon.png" class="nav-menu-icons">MIS Reports</span>
	<div class="collapse <?php if($this->uri->segment(2)=='misreports'  || $this->uri->segment(2)=='api_misreports' ) { echo 'collapse in';}?>" id="misreports">
	<ul class="left-submenu">  
<li><a class="<?php if($this->uri->segment(2)=='misreports') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/misreports">Campaign Reports</a></li>
<li><a class="<?php if($this->uri->segment(2)=='api_misreports' ) { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/api_misreports">API Reports</a></li></ul></div>	</li>
     <?php }else { ?>
...
<?php if(  $this->session->userdata('user_id') ==  4857  || $this->session->userdata('user_id') ==  4904  )   { } else{ ?>
<ul class="left-submenu"> 
       
<li><a class="<?php if($this->uri->segment(2)=='normalSMS') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/normalSMS">Normal SMS</a></li>
<li><a class="<?php if($this->uri->segment(2)=='fileSMS') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/fileSMS">File SMS</a></li> 
<li><a class="<?php if($this->uri->segment(2)=='newVariableSMS') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/newVariableSMS">Custom SMS</a></li> 
<li><a class="<?php if($this->uri->segment(2)=='unicodeSMS') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/unicodeSMS">Unicode SMS</a></li> 
<!-- ADDED ON 2017-01-30
...
<ul class="left-submenu">       
		   ...
		   <li><a class="<?php if($this->uri->segment(2)=='dedicated') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/longcode/dedicated">Dedicated Number</a></li>  

		   <li><a class="<?php if($this->uri->segment(2)=='shared') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/longcode/shared">Shared Number</a></li>
	  </ul>
</div>
</li>
...
<ul class="left-submenu">       
	...
	<li><a class="<?php if($this->uri->segment(2)=='bulkShorturl') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/bulkShorturl">Generate URLs</a></li>
...
<?php //if($this->session->userdata('user_id') == 2917) { ?>
<li>

<span class="submenuli collapsed<?php if($this->uri->segment(2)=='misreports' || $this->uri->segment(2)=='api_misreports' ) { echo 'in leftmenutoggle';}?> " data-toggle="collapse" data-target="#misreports"><img src="<?php echo base_url();?>images/reports-icon.png" class="nav-menu-icons">MIS Reports</span>

	<div class="collapse <?php if($this->uri->segment(2)=='misreports'  || $this->uri->segment(2)=='api_misreports' ) { echo 'collapse in';}?>" id="misreports">
		
		<ul class="left-submenu">
<li><a class="<?php if($this->uri->segment(2)=='misreports') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/misreports">Campaign Reports</a></li>
<li><a class="<?php if($this->uri->segment(2)=='api_misreports' ) { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/api_misreports">API Reports</a></li>
...
<ul class="left-submenu">
	 <li><a class="<?php if($this->uri->segment(1)=='home' && $this->uri->segment(2)=='index') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/home/index">Credits History</a></li>
 	<li><a class="<?php if($this->uri->segment(2)=='block_listed_numbers') { echo 'activelink';}?>" href="<?php echo base_url(); ?>mytemplate/block_listed_numbers">Blocked Numbers</a></li> 
	  <li><a class="<?php if($this->uri->segment(2)=='templates' || $this->uri->segment(2)=='getRecentTemplate') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/mytemplate/templates">Template</a></li>
	   <li><a class="<?php if($this->uri->segment(1)=='contacts' && $this->uri->segment(2)=='index') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/contacts/index">Groups</a></li>
	    <?php //if($this->session->userdata('no_ndnc') == 1) {    ?>
	    <li><a class="<?php if($this->uri->segment(2)=='sender_names') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/mytemplate/sender_names">Sender ID</a></li>  
		<?php //} ?>  
...
<ul class="left-submenu">
<li><a class="<?php if($this->uri->segment(1)=='longcode' || $this->uri->segment(2)=='packages') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/longcode/packages">Longcode Package</a></li>  

<li><a class="<?php if($this->uri->segment(1)=='products' || $this->uri->segment(2)=='shoppingCartView') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/products/index">My Order</a></li>

<!-- <li><a href="<?php echo base_url(); ?>myaccount/payments">Balance History</a></li> -->
...
<ul class="left-submenu">
  ...
  <li><a class="<?php if($this->uri->segment(1)=='longcode' && $this->uri->segment(2)=='add_credits') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/longcode/add_credits">LongCode Credits</a></li>
  <li><a class="<?php if($this->uri->segment(1)=='campaign' && $this->uri->segment(2)=='addShorturlCredits') { echo 'activelink';}?>" href="<?php echo base_url(); ?>index.php/campaign/addShorturlCredits">ShortURL Credits </a></li>
