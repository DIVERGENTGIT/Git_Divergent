            ...
            var chartDatacust2 = [
                {
                ...
                },
                 {
                    ...
                    "numcust": <?php if(!empty($getMonthCampaignCustomized[1]['totalmsg'])){ echo $getMonthCampaignCustomized[1]['totalmsg']; }else{ echo "0";}?>
                },
                {
                ...
                },
                {
                    ...
                    "numcust": <?php if(!empty($getMonthCampaignCustomized[3]['totalmsg'])){ echo $getMonthCampaignCustomized[3]['totalmsg']; }else{ echo "0";}?>
                },
                {
                ...
                },
                {
                    ...
                    "numcust": <?php if(!empty($getMonthCampaignCustomized[14]['totalmsg'])){ echo $getMonthCampaignCustomized[14]['totalmsg']; }else{ echo "0";}?>
                },
                {
                ...
                },
                {
                    ...
                    "numcust": <?php if(!empty($getMonthCampaignCustomized[18]['totalmsg'])){ echo $getMonthCampaignCustomized[18]['totalmsg']; }else{ echo "0";}?>
                },
                {
                ...
                {
                    "monthcust": "<?php if(!empty($getMonthCampaignCustomized[31]['daywise'])){ echo $getMonthCampaignCustomized[31]['daywise']; }else{ echo "0";}?>",
                    "numcust": <?php if(!empty($getMonthCampaignCustomized[31]['totalmsg'])){ echo $getMonthCampaignCustomized[31]['totalmsg']; }else{ echo "0";}?>
                }
...
$monthNum  = $getYearCampaignCustomized[4]['daywise'];
                ...
                {
                    "year": "<?php if(!empty($getYearCampaignCustomized[10]['daywise'])){ 
