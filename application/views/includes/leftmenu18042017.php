...
<nav class="navbar navbar-default custom-menu">
 ...
 <li>
 <span class="submenuli <?php if($this->uri->segment(2)=='normalSMS' || $this->uri->segment(2)=='fileSMS'  || $this->uri->segment(2)=='newVariableSMS' || $this->uri->segment(2)=='unicodeSMS') { echo 'in leftmenutoggle';}?>" data-toggle="collapse" data-target="#smsmenuacc">
...
<li><a href="<?php echo base_url();?>customized/newVariableSMS">Custom</a></li>  -->
 ...
 <li><span class="submenuli <?php if($this->uri->segment(2)=='dedicated' || $this->uri->segment(2)=='shared') { echo 'in leftmenutoggle';}?>" data-toggle="collapse" data-target="#longmenuacc">
...
<ul class="left-submenu">       
 ...
 <li><span class="submenuli <?php if($this->uri->segment(2)=='bulkShorturl') { echo 'in leftmenutoggle';}?>" data-toggle="collapse" data-target="#shorturlacc">
...
<li>
			<span class="submenuli <?php if($this->uri->segment(2)=='viewcampaigns' || $this->uri->segment(2)=='reports' || $this->uri->segment(2)=='shorturl_allreports') { echo 'in leftmenutoggle';}?> " data-toggle="collapse" data-target="#ftpcampaign"><img src="<?php echo base_url();?>images/reports-icon.png" class="nav-menu-icons">Service Reports</span>
			<div class="collapse <?php if($this->uri->segment(2)=='viewcampaigns' || $this->uri->segment(2)=='reports' || $this->uri->segment(2)=='shorturl_allreports') { echo 'collapse in';}?>" id="ftpcampaign">
				<ul class="left-submenu">
				
<li><a class="<?php if($this->uri->segment(2)=='viewcampaigns') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/viewcampaigns">SMS Reports</a></li>
 <li><a class="<?php if($this->uri->segment(2)=='reports') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/longcode/reports">LongCode Reports</a></li>
 <li><a class="<?php if($this->uri->segment(2)=='shorturl_allreports') { echo 'activelink';}?>" href="<?php echo base_url();?>index.php/campaign/shorturl_allreports">ShortURL Reports</a></li>
<?php if($isftpuser == 1) { ?>
...
<?php } ?>
		...
		<li><span class="submenuli <?php if($this->uri->segment(2)=='templates' || ($this->uri->segment(1)=='contacts' && $this->uri->segment(2)=='index') || $this->uri->segment(2)=='sender_names' || $this->uri->segment(2)=='myUsers') { echo 'in leftmenutoggle';}?>" data-toggle="collapse" data-target="#managemenuacc"><img src="<?php echo base_url();?>images/manage-icon.png" class="nav-menu-icons">Manage</span>
		<div class="collapse <?php if($this->uri->segment(2)=='templates' || ($this->uri->segment(1)=='contacts' && $this->uri->segment(2)=='index') || $this->uri->segment(2)=='sender_names' || $this->uri->segment(2)=='myUsers') { echo 'collapse in';}?>" id="managemenuacc">   
<ul class="left-submenu">
	  <li><a class="<?php if($this->uri->segment(2)=='templates') { echo 'activelink';}?>" href="<?php echo base_url(); ?>mytemplate/templates">Template</a></li>
	   <li><a class="<?php if($this->uri->segment(2)=='index') { echo 'activelink';}?>" href="<?php echo base_url();?>contacts/index">Groups</a></li>
		...
		<li><span class="submenuli <?php if($this->uri->segment(2)=='packages' || ($this->uri->segment(1)=='products' && $this->uri->segment(2)=='index') || $this->uri->segment(2)=='order_history') { echo 'in leftmenutoggle';}?> " data-toggle="collapse" data-target="#paymentmenuacc"><img src="<?php echo base_url();?>images/payments-icon.png" class="nav-menu-icons">Payments</span>
		<div class="collapse <?php if($this->uri->segment(2)=='packages' || ($this->uri->segment(1)=='products' && $this->uri->segment(2)=='index') || $this->uri->segment(2)=='order_history') { echo 'collapse in';}?>" id="paymentmenuacc">
<ul class="left-submenu">
<!--
<li><a class="<?php if($this->uri->segment(2)=='myLongcodePackage') { echo 'activelink';}?>" href="<?php echo base_url(); ?>campaign/myLongcodePackage">Longcode Package</a></li>
-->
<li><a class="<?php if($this->uri->segment(2)=='packages') { echo 'activelink';}?>" href="<?php echo base_url(); ?>longcode/packages">Longcode Package</a></li>

<li><a class="<?php if($this->uri->segment(1)=='products') { echo 'activelink';}?>" href="<?php echo base_url(); ?>products/index">My Order</a></li>
<!-- <li><a href="<?php echo base_url(); ?>index.php/myaccount/payments">Balance History</a></li> -->
<li><a class="<?php if($this->uri->segment(2)=='order_history') { echo 'activelink';}?>" href="<?php echo base_url(); ?>Payment/order_history">Payment History</a></li>
</ul>
</div> 
</li>
  
	<li><span class="submenuli <?php if($this->uri->segment(2)=='add_credits' || $this->uri->segment(2)=='addShorturlCredits') { echo 'in leftmenutoggle';}?>" data-toggle="collapse" data-target="#balncemenuacc"><img src="<?php echo base_url();?>images/credits-icon.png" class="nav-menu-icons">Add Credits</span>
