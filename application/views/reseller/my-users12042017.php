...
<a href="#addusermodel" data-toggle="modal" data-target="#addusermodel" class="submit_btn pull-right">Add User</a>
 ...
 <section class="col-sm-12 col-md-12 col-xs-12 padding_zero">
			...
			<td><?php echo $sno;?></td>
                        ...
                        <td><a data-href="<?php echo base_url(); ?>index.php/reseller/myUsers/usersbalance/puid/<?php echo $user->user_id; ?>";  class="T-Color btn btn-default btn-sm" style="text-decoration:none;"  data-toggle="modal" data-target="#Creat-user-Modal<?php echo $user->user_id;?>"> Add SMS Credits</a>
...
<?php 
	...
	?>
						...
						<td><a data-href="<?php echo base_url(); ?>index.php/reseller/myUsers/usersbalance/puid/<?php echo $user->user_id; ?>";  class="T-Color btn btn-default btn-sm" style="text-decoration:none;"  data-toggle="modal" data-target="#Deduct-bal-Modal<?php echo $user->user_id;?>">Deduct SMS Credits</a>
