...
<a href="#addusermodel" data-toggle="modal" data-target="#addusermodel" class="submit_btn pull-right">Add User</a>
        ...
        <section class="col-sm-12 col-md-12 col-xs-12 padding_zero">
				...
				echo @$usernamemsg;
				?>
                  <table id="example1" class="table_all">
                    <thead>
                      <tr>
                        <th>S No</th>
                        <th>User Name</th>
			...
			<td><?php echo $countu; ?></td>
                        ...
                        <td><a data-href="<?php echo base_url(); ?>index.php/reseller/myUsers/usersbalance/puid/<?php echo $user->user_id; ?>";  class="T-Color btn btn-default btn-sm" style="text-decoration:none;"  data-toggle="modal" data-target="#Creat-user-Modal<?php echo $user->user_id;?>"> Add Balance</a>
...
<form class="form-horizontal add_sms_form<?php echo $countu;?>" method="POST" action="<?php echo base_url()?>index.php/reseller/myUsers" name="add_sms_form">
...
<input type="submit"  name="add_balance" class="submit_btn" value="Add Balance"/>
        </div>
</div>
<div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
<div class="table-responsive">
...
<?php 
	...
	?>
						...
						<td><a data-href="<?php echo base_url(); ?>index.php/reseller/myUsers/usersbalance/puid/<?php echo $user->user_id; ?>";  class="T-Color btn btn-default btn-sm" style="text-decoration:none;"  data-toggle="modal" data-target="#Deduct-bal-Modal<?php echo $user->user_id;?>">Deduct Balance</a>
	...
	<div id="Deduct-bal-Modal<?php echo $user->user_id;?>" class="modal fade" tabindex="-1" role="dialog">         
        ...
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content col-md-12 col-sm-12 col-xs-12">           
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">User Deduct Balance</h4>
                </div>
                <div class="modal-body col-md-12 col-sm-12 col-xs-12 padding_zero">
		<form class="form-horizontal deduct_sms_form<?php echo $countu;?>" method="POST" action="<?php echo base_url()?>index.php/reseller/myUsers" name="deduct_sms_form">
  ...
  <div class="col-md-3 col-sm-3 col-xs-12">
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12 form-div padding_zero">
            ...
            <input type="hidden" class="form-control" id="resellers_user_id" name="resellers_user_id" value="<?php echo $user->user_id;?>" />
<input type="submit"  name="deduct_balance" class="submit_btn" value="Deduct Balance"/>
</div>
...
<?php 
	...
	<!-- Deduct balance ending -->	
                        ...
                        <td> 
			<a data-href="<?php echo base_url(); ?>index.php/reseller/myUsers/usereditails/<?php echo $user->user_id; ?>";  class="T-Color btn btn-default btn-sm" style="text-decoration:none;"  data-toggle="modal" data-target="#edit-user-Modal<?php echo $user->user_id;?>"> Edit</a>
  ...
  <!--                  
  <?php echo form_open('index.php/reseller/myUsers',array('id' => 'edit_profile_form','class' => 'edit_profile_form', 'name' => 'edit_profile_form', 'method' => 'post')); ?>
  --->
  <form method="post" action="" id="edit_profile_form" class="edit_profile_form<?php echo $countu?>" 
...
<form class="validation-signup" method="post" action="">
...
<div class="col-sm-8 col-md-8 col-xs-12 padding_rtzero padding_mzero">
<input type="text" name="lastname" id="lastname" placeholder="User Name">
</div>
</div>
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-sm-4 col-md-4 col-xs-12 padding_zero">
...
<div class="col-sm-8 col-md-8 col-xs-12 padding_rtzero padding_mzero">
<input type="text" name="email"  id="emailid" maxlength="30" minlength="4" placeholder="Email address">
</div>
</div>
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-sm-4 col-md-4 col-xs-12 padding_zero">
