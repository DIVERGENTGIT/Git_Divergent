...
<div class="form">
    ...
    <h3>Contact Details</h3>          	
     ...
     <h3>SMS Credits</h3>
     		<fieldset>
     				<dl>
                        <dt><label for="no.of sms">No.of SMS</label></dt>
                        <dd>
                        	<?php echo form_input(array('name' => 'no_of_sms', 'id' => 'no_of_sms', 'maxlength' => 45, 'value' => set_value('no_of_sms'), 'class' => 'inputText' ));?>
                        	<div class="form_error"><?php echo form_error('no_of_sms'); ?></div>
                        </dd>
                    </dl>
                    <dl>
                        <dt><label for="no.of sms">price</label></dt>
                        <dd>
                        	<?php echo form_input(array('name' => 'price', 'id' => 'price', 'maxlength' => 45, 'value' => set_value('price'), 'class' => 'inputText' ));?>
                        	<div class="form_error"><?php echo form_error('price'); ?></div>
                        </dd>
                    </dl>
                                        
                     <dl class="submit">
                   		<?php echo form_submit(array('name' => 'register','value' => 'Create User', 'class' => 'button'));?>
                     </dl>
