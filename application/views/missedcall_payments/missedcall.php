 ...
 <div class="modal fade" id="addmissedcallmodel" role="dialog">
    <div class="modal-dialog template_modal_div">
      ...
      <div class="modal-content col-md-12 col-sm-12 col-xs-12 padding_zero">
		...
		<li class="currentmisstab"><a href="#exist-cust"  class="existing_order_numbers" >Existing</a></li>
...
<li><div class="all_checkbox">
  <input id="existi-num01" type="checkbox" class="checkboxsmsmis" name="field" value="option" placeholder="">
  <label class="font_normal" for="existi-num01"><span><span></span></span>040-00000</label>
</div>
</li>
<li><div class="all_checkbox">
  <input id="existi-num02" type="checkbox" name="field" class="checkboxsmsmis" value="option" placeholder="">
  <label class="font_normal" for="existi-num02"><span><span></span></span>040-00000</label>
</div>
</li>
<li><div class="all_checkbox">
  <input id="existi-num03" type="checkbox" name="field" class="checkboxsmsmis" value="option" placeholder="">
  <label class="font_normal" for="existi-num03"><span><span></span></span>040-00000</label>
</div>
</li>
-->
 ...
 $(document).ready(function() {
  ...
  $(".userlogin_from").hide();*/
		...
		$.ajax({
			...
			url: "<?php echo base_url();?>Payment/order_numbers",
	      ...
	      //get_did_numbers
			...
			type: "GET",
			data: {},
			url: "<?php echo base_url(); ?>Payment/get_did_numbers",
	        ...
	        $.ajax({
				type: "GET",
				data: {},
				url: "<?php echo base_url(); ?>Payment/getuserforms",
				success: function (callback_data) 
				{
				console.log(callback_data);
...
var user_id = "<?php echo $this->session->userdata('user_id')?>";
    ...
    var plan_service=$.trim($("#plan_service").val());
		...
		$.ajax({
			...
			url: "<?php echo base_url(); ?>Payment/existing_order_numbers",
			success: function(data)
			{
				console.log(data);
