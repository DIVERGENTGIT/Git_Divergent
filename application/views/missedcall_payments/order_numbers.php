...
<div class="total_price">
	...
	<span id="snos_cost" class="total-price">0.00</span>
	</div>
	</div>
...
<script>
 $(document).ready(function() {
	...
	type: "GET",
	data: {},
	url: "<?php echo base_url(); ?>Payment/DisplayNumbers",
	...
	$('.didprice').html(callback_data);
		...
		$.ajax({
			...
			url: "<?php echo base_url();?>Payment/Search_silverno",
    ...
    $(".silver_search_button").on("click",function(event) {
		...
		$.ajax({
			...
			url:"<?php echo base_url();?>Payment/Search_goldno",
			success:function(data){
				console.log(data);
	...
	$(".gold_search_button").on("click",function(event){
	  ...
	  var platinumno = $.trim($(".platinum_search").val());
		...
		$.ajax({
			...
			url:"<?php echo base_url();?>Payment/Search_platinumno",
			success:function(data){
				console.log(data);
