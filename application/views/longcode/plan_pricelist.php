...
<thead>
<tr><!--<th rowspan="2">SMS Pack Range</th><th colspan="2">Price Per SMS <span class="indian-rupee"><img src="http://strikersoftsolutions.com/images/firstring-email/rupee-indian-white.png"  alt=""></span> </th><th rowspan="2">&nbsp;</th> -->


<th rowspan="2">Number Of Sms</th><th>Price Per Long Code</th><th>Subscription Duration</th><th rowspan="2">Amount</th></tr>
<tr>
...
<td><?php echo $value->price_per_long_code;?>
</td>
<td><?php  echo $value->subscription_duration;?> 
</td>
