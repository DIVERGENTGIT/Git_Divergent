...
<h3 class="right-content-title"><img src="<?php echo base_url();?>images/longcode-icon.png" class="right-title-img">Dedicated</h3>
</div>
...
<form class="missedcall_allform missedcall_allformsub" method="post" enctype="multipart/form-data">
 ...
 <label class="form_lable lablefont">Long Code Number</label>
                    ...
                    <div class="col-sm-7 col-md-7 col-xs-12 padding_mzero">
                      <!--
...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
				<span class="">
				<a href="#addkeywordmodel" data-toggle="modal" class="add_pluse addkeywords" data-target="#addkeywordmodel">
                                    <i class="fa fa-plus"></i>
                                    <span>Add</span>
                                </a></span>
				</div>
...
<label class="checklable">Customer SMS</label>
				
				<input type="hidden" name="customersmsreqired" value="1" id="customersmsreqired">
				<!--<input type="checkbox" name="customersms" id="customersms">
				  <label class="font_normal" for="customersms"><span><span></span></span>Customer SMS</label>-->
...
<div class="col-sm-12 col-md-12 col-xs-12 vendorshowdiv form-div padding_zero" style="display:none;">
...
?>
				...
				<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
		            <input type="text" name="vendor_mobileno" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" placeholder="Phone Number"  value="<?php echo @$mobile;?>" 
...
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-7 col-md-7 col-xs-12 col-sm-offset-3 padding_mzero col-md-offset-2">
<input type="text" name="phone_number" id="phone_number" maxlength="12" placeholder="Enter Phone Number Parameter (ex: Phoneno)">				
			</div>
			</div>
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-7 col-md-7 col-xs-12 col-sm-offset-3 padding_mzero col-md-offset-2">
<input type="text" name="service_numbers" id="service_numbers" maxlength="12" placeholder="Enter Service Number Parameter (ex: Serviceno)">				
			</div>
			</div> 
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-7 col-md-7 col-xs-12 col-sm-offset-3 padding_mzero col-md-offset-2">
...
<input type="hidden" name="api_alert" id="api_alert" >	 			
			...
			<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-4 col-md-4 col-xs-12 col-sm-offset-3 padding_mzero col-md-offset-2">
<input type="submit" name="LongcodeSubmit" value="Submit" class="mrgtop10 submit_btn">				
			</div>
			</div>
                </div>
				</form>
...
<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
<div class="col-sm-4 col-md-4 col-sm-offset-3 col-md-offset-3 col-xs-12">
				<div class="col-sm-12 col-md-12 col-xs-12 padding_zero">
...
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-5 col-md-5 col-xs-12 col-sm-offset-3 col-md-offset-3">
<input type="text" name="phone_number<?php echo $keyworddata->longcode_id;?>" maxlength="10" id="phone_number" value="<?php echo $keyworddata->phone_number;?>"
 placeholder="Enter Phone Number Parameter (ex: Phoneno)" maxlength="10" >				
			</div>
			</div>
<div class="col-sm-12 col-md-12 col-xs-12 form-div padding_zero">
			<div class="col-sm-5 col-md-5 col-xs-12 col-sm-offset-3 col-md-offset-3">
<input type="text" name="service_numbers<?php echo $keyworddata->longcode_id;?>" maxlength="12" id="service_numbers" value="<?php echo $keyworddata->service_numbers;?>"
 ...
 <script type="text/javascript">
  ...
  <!-- Model End -->
		...
		<span class="btn btn-sm btn-default"   
					...
					style="" 
					data-href="dedicated/delete/<?php echo $keyworddata->longcode_id;?>";
					>Delete</span>
...
<!-- Add Missedcall Model Start -->
  <div class="modal fade" id="addloncodemodel" role="dialog">
	...
	<div class="col-md-2 col-sm-2 col-xs-12 pos_abs round-priceing padding_zero">
	<div class="total_price">
	<div class="total-price-lable">
	<span>Total <br>Price ( <i class="fa fa-inr" aria-hidden="true"></i> ) </span>
	</div>
	...
	<div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
	 <div class="smsadmintabdiv missedcall_allform">
	        ...
	        <!-- displaysilvertab end-->
			 ...
			 <!-- displaygoldtab start-->
			        <div class="displaygoldtab">
			        </div>
			   <!-- displaygoldtab end-->
			 ...
			 <div id="platinumtab" class="missadmintab-content" style="display:none">
			  <!-- displayplatinumtab start-->
			        <div class="displayplatinumtab">
			        </div>
			 <!-- displayplatinumtab end-->
			</div>
...
$('#longcode_apiedit').change(function(){

  if($(this).prop("checked")) {
  
    $('.api_show_divedit').show();

  } else {
    $('.api_show_divedit').hide();
