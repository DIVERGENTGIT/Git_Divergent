...
<table class="table_all">
	...
	?>
		...
		<span class="btn btn-sm btn-default editsharedkeywordspan<?php echo $keyword->keyword_id;?>">Edit1</span>
...
$(document).ready(function() {
	...
	$.ajax({
	method:"GET",
	url:"<?php echo base_url()?>longcode_shared/displaykewords",
	success:function(data){
	...
	$(".displaytable").html(data);
	 ...
	 if(longcode_numbers!='')
	 {
		 ...
		 if(getkeyword!='')
		 {
				...
				method:"GET",
				dataType:"json",
				data : {getkeyword:getkeyword,longcode_numbers:longcode_numbers,service_type:"shared"},
				url:"<?php echo base_url()?>longcode_shared/createkeyword",
				success:function(data){
 ...
 $(".updatekeyword").on("click",function() {
	 ...
	 if(longcode_numbers!='')
	 {
		 ...
		 if(getkeyword!='')
		 {
				...
				url:"<?php echo base_url()?>longcode_shared/keywordupdate",
				success:function(data){
