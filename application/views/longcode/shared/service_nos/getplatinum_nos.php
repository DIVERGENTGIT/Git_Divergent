		...
		<!--
		<select class="getplatinumkeyword">
		...
		<input type="text" class="getplatinumkeyword" placeholder="Enter Keyword">
		-->
		<input type="text" class="getplatinumkeyword" placeholder="Enter Keyword">
		<span class="platinumkeywordmsg"></span>
		</div>
		
		<div class="col-md-3 col-sm-3 form-div padding_ltzero col-xs-12">
		<input type="text" class="getplatinumnumber" placeholder="Number">
		</div>
		<div class="col-md-2 col-sm-2 col-xs-12 form-div padding_zero">
		<!--  
		<input type="submit" name="" class="create-btn" value="Search">
		-->
		<input type="submit" name="" class="submit_btn sharedplatinumsearch" value="Submit">
		</div>
		</div>
		</div>
		<div class="col-md-12 col-sm-12 col-xs-12 padding_zero">
    ...
    $(document).ready(function(){
        $(".getplatinumnumber<?php echo $longcode_number->longcode_number;?>").click(function(){
            ...
            if($(this).prop("checked") == true){
				...
				$.ajax({
				type: "GET",
				data: {snosprice:snosprice,getkeyword:getplatinumkeyword,getsubscription:getplatinumsubscription,status:'1'},
				...
				$.ajax({
				type: "GET",
				data: {snosprice:snosprice,getkeyword:getplatinumkeyword,getsubscription:getplatinumsubscription,status:'0'},
