...
<input type="submit" name="LongcodeSubmit" value="Submit" class="submit_btn">		
		...
		<table class="table_all" id="example1">
		<thead>
		<tr>
		<th>S.No</th>
		<th>Keywords</th>
...
<input type="submit" name="editlongcode_config" class="temp-append-btn create-btn" value="Update">
  ...
  <div class="modal fade" id="addloncodemodel" role="dialog">
    <div class="modal-dialog template_modal_div">
      ...
      <div class="modal-content col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="modal-header">
		 <h4 class="modal-title">Service Number Selection</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
...
$(".missedcall_allformsub").validate({
 ...
 <script type="text/javascript">
    $(document).ready(function(){
		...
		type: "GET",
		data: {},
		url: "<?php echo base_url(); ?>longcode_shared/DisplayNumbers",
