...
$( document ).ready(function( $ ) {
	var trn_id=  "<?php echo $_REQUEST['tn']?>";
       ...
       var urlvar="<?php echo base_url(); ?>API/longcode/renwal_shared.php?payment=payment&trn_id="+trn_id+"&servicetax="+servicetax+"&tax="+tax+"&smsprice="+smsprice;
...
<div class="col-sm-7 col-md-7 col-xs-12  padding-ltzero padding-mzero">
<?php echo @$_SESSION['noofkeywords'];?>
</div>
</div>
...
<?php
      ...
      if(@$_SESSION['longcode_number']!='')
      {
			...
			$noofkeywords=$_SESSION['noofkeywords'];
		 ...
		 $sql1="select * from price_enquery  where registeruser_id=$user_id and longcode_numbers='$longcode_numbers' and payment_status=0 and description='longcode Shared Renewal' group by longcode_numbers";
...
$noofsms=0;
	 ...
	 '$amount','$total_tax','$total_amount','$longcode_numbers','longcode Shared Renewal')";
...
<input type="hidden" name="qty" value="<?php echo $noofkeywords;?>">
...
<input type="hidden" name="description" value="longcode Shared Renewal">
...
// get order numbers
$sql2="select * from longcode_tmp where service_type='shared'  and user_id=$user_id group by longcode_number";
