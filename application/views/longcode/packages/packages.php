...
<div class="col-md-7 col-sm-7 padding_rtzero padding_mzero col-xs-12">
<i class="fa fa-inr" aria-hidden="true"></i>
<span  class="amount<?php echo $longcode_report->longcode_id;?>"  >
...
<div class="col-md-12 col-sm-12 col-xs-12 form-div padding_zero">
<div class="col-md-5 col-sm-5 padding_zero col-xs-12">
<span class="form_lable03">Total Tax <br>( <?php echo @$tax;?> % )</span>
</div>
<div class="col-md-7 col-sm-7 padding_rtzero padding_mzero col-xs-12">
<i class="fa fa-inr" aria-hidden="true"></i> 
<span class="renewal_tax total_tax<?php echo $longcode_report->longcode_id;?>"  >
...
<div class="col-md-7 col-sm-7 padding_rtzero padding_mzero col-xs-12">
<i class="fa fa-inr" aria-hidden="true"></i>
<span  class="total_amount<?php echo $longcode_report->longcode_id;?>" >
