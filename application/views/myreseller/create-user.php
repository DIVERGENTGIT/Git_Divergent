...
<?php //echo form_open('reseller/createUser',
    ...
    <form method="POST" action="http://www.smsstriker.com/index.php/reseller/createUser"  class="form-inline" id="add_user_form" name="add_user_form">
                     
  
  <div class="col-lg-10"  >
          <h4  style="color:#777; margin-bottom:10px !important; background-color:#F5F5F5; line-height:25px;margin-top:0px;  padding:5px 10px !important;">Account Details</h4>
        </div>
 ...
 <div class="col-lg-10" >
  ...
  <div class="form-group col-md-5">
    ...
    <div class="col-md-8 input-group input-group-sm">
    <span class="input-group-addon"><span class="glyphicon glyphicon-ind"></span></span> 
